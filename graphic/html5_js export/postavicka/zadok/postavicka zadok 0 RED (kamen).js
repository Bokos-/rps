...
(lib.postavkabackanimacia0papierred = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(34.7,72.2,1,1,0,0,0,39.1,46.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:26.7,regY:35.1,rotation:0.1,x:22.4,y:60.8},0).wait(1).to({rotation:0.2},0).wait(2).to({rotation:0.3},0).wait(1).to({rotation:0.4},0).wait(1).to({rotation:0.5,y:60.7},0).wait(1).to({rotation:0.6,x:22.5,y:60.8},0).wait(1).to({rotation:0.8,y:60.7},0).wait(1).to({rotation:1},0).wait(1).to({rotation:1.2,x:22.6,y:60.6},0).wait(1).to({rotation:1.5,y:60.5},0).wait(1).to({rotation:1.9,x:22.7},0).wait(1).to({rotation:2.5,x:22.8,y:60.3},0).wait(1).to({rotation:3.1,x:22.9,y:60.2},0).wait(1).to({rotation:3.5,x:23,y:60.1},0).wait(1).to({rotation:3.8,x:23.1,y:60},0).wait(1).to({rotation:4.1,x:23.2},0).wait(1).to({rotation:4.3},0).wait(1).to({rotation:4.4,y:59.9},0).wait(1).to({rotation:4.6},0).wait(1).to({rotation:4.7,x:23.3},0).wait(2).to({rotation:4.8},0).wait(4).to({rotation:4.7},0).wait(1).to({rotation:4.6},0).wait(1).to({rotation:4.5,x:23.2,y:60},0).wait(1).to({rotation:4.3},0).wait(1).to({rotation:4.1},0).wait(1).to({rotation:3.9,x:23.1},0).wait(1).to({rotation:3.7,y:60.1},0).wait(1).to({rotation:3.3,x:23,y:60.2},0).wait(1).to({rotation:2.9,x:22.9},0).wait(1).to({rotation:2.4,y:60.3},0).wait(1).to({rotation:1.9,x:22.7,y:60.5},0).wait(1).to({rotation:1.5,x:22.6,y:60.6},0).wait(1).to({rotation:1.1,y:60.7},0).wait(1).to({rotation:0.9,x:22.5},0).wait(1).to({rotation:0.7},0).wait(1).to({rotation:0.5,x:22.4},0).wait(1).to({rotation:0.3,y:60.8},0).wait(1).to({rotation:0.2},0).wait(1).to({rotation:0.1,x:22.3},0).wait(1).to({y:60.9},0).wait(1).to({rotation:0},0).wait(3));
...
p.nominalBounds = new cjs.Rectangle(30.6,64.7,69.1,98.4);
