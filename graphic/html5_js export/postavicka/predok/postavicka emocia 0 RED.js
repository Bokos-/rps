...
lib.properties = {
	...
	manifest: [
		...
		{src:"postavicka p (png)/kapuca11.png", id:"kapuca11"},
...
(lib.kapuca11 = function() {
	this.initialize(img.kapuca11);
}).prototype = p = new cjs.Bitmap();
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.kapuca11();
	this.instance.setTransform(0,0,0.317,0.305);
...
// stage content:
(lib.postvickaanimaciaemocia0RED = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(3).to({x:33.8},0).wait(4).to({x:33.7},0).wait(2).to({alpha:0.5},0).wait(1).to({alpha:1},0).wait(1).to({x:33.6,alpha:0.5},0).wait(1).to({alpha:0},0).wait(38));

	// oko vnutro
	this.instance_6 = new lib.Symbol14();
	this.instance_6.setTransform(32.8,40.2,1,1,0,0,0,14.6,6.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({regY:6.6,y:40.3},0).wait(49));
	...
	this.instance_9.setTransform(33.2,104.8,1,1,0,0,0,5.5,4.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({regX:5.6,regY:4.3,x:33.3,y:104.9},0).wait(49));

	// ruka
	this.instance_10 = new lib.Symbol17();
	this.instance_10.setTransform(23.8,79.4,1,1,0,0,0,9.5,8.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1).to({y:79.3},0).wait(1).to({y:79.2},0).wait(1).to({y:79.1},0).wait(1).to({y:79},0).wait(2).to({y:78.9},0).wait(1).to({y:78.8},0).wait(1).to({y:78.7},0).wait(1).to({y:78.6},0).wait(2).to({y:78.5},0).wait(1).to({y:78.4},0).wait(1).to({y:78.3},0).wait(2).to({y:78.2},0).wait(1).to({y:78.1},0).wait(2).to({y:78},0).wait(1).to({y:77.9},0).wait(1).to({y:77.8},0).wait(2).to({y:77.7},0).wait(1).to({y:77.6},0).wait(3).to({y:77.7},0).wait(1).to({y:77.8},0).wait(2).to({y:77.9},0).wait(1).to({y:78},0).wait(1).to({y:78.1},0).wait(2).to({y:78.2},0).wait(1).to({y:78.3},0).wait(1).to({y:78.4},0).wait(2).to({y:78.5},0).wait(1).to({y:78.6},0).wait(1).to({y:78.7},0).wait(2).to({y:78.8},0).wait(1).to({y:78.9},0).wait(1).to({y:79},0).wait(2).to({y:79.1},0).wait(1).to({y:79.2},0).wait(1).to({y:79.3},0).wait(2).to({y:79.4},0).wait(1));

	// oblecko
	this.instance_11 = new lib.Symbol18();
	this.instance_11.setTransform(33,82.8,1,1,0,0,0,24.1,24.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1).to({x:32.9,y:82.7},0).wait(1).to({y:82.6},0).wait(1).to({y:82.5},0).wait(1).to({y:82.4},0).wait(1).to({x:33,y:82.3},0).wait(1).to({y:82.2},0).wait(1).to({y:82.1},0).wait(1).to({y:82},0).wait(1).to({y:81.9},0).wait(1).to({y:81.8},0).wait(2).to({y:81.7},0).wait(1).to({x:33.1,y:81.6},0).wait(1).to({y:81.5},0).wait(1).to({y:81.4},0).wait(1).to({y:81.3},0).wait(1).to({y:81.2},0).wait(1).to({y:81.1},0).wait(2).to({y:81},0).wait(1).to({y:80.9},0).wait(1).to({y:80.8},0).wait(1).to({y:80.7},0).wait(1).to({y:80.6},0).wait(1).to({y:80.7},0).wait(1).to({y:80.8},0).wait(1).to({y:80.9},0).wait(2).to({y:81},0).wait(1).to({y:81.1},0).wait(1).to({y:81.2},0).wait(1).to({y:81.3},0).wait(1).to({y:81.4},0).wait(1).to({y:81.5},0).wait(1).to({y:81.6},0).wait(1).to({x:33},0).wait(1).to({y:81.7},0).wait(1).to({y:81.8},0).wait(1).to({y:81.9},0).wait(1).to({y:82},0).wait(1).to({y:82.1},0).wait(2).to({y:82.2},0).wait(1).to({y:82.3},0).wait(1).to({y:82.4},0).wait(1).to({y:82.5},0).wait(1).to({y:82.6},0).wait(1).to({x:32.9,y:82.7},0).wait(1).to({y:82.8},0).wait(1));
