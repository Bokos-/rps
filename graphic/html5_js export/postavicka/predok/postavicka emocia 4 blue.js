...
// stage content:
(lib.postvickaanimaciaemocia4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(4).to({x:33.1,y:81.9},0).wait(1).to({y:81.7},0).wait(1).to({y:81.5},0).wait(1).to({y:81.3},0).wait(1).to({y:81.1},0).wait(1).to({y:80.9},0).wait(1).to({x:33,y:80.7},0).wait(1).to({y:80.9},0).wait(1).to({y:79.9},0).wait(1).to({y:78.8},0).wait(1).to({y:77.7},0).wait(1).to({y:76.7},0).wait(1).to({y:75.6},0).wait(1).to({y:74.5},0).wait(1).to({x:33.1,y:73.5},0).wait(1).to({y:74.1},0).wait(1).to({y:74.8},0).wait(1).to({y:75.4},0).wait(1).to({y:76.1},0).wait(1).to({y:76.8},0).wait(1).to({y:77.4},0).wait(1).to({x:33,y:78.1},0).wait(1).to({y:78.7},0).wait(1).to({y:79.4},0).wait(1).to({y:79.9},0).wait(1).to({y:80.2},0).wait(1).to({y:80.6},0).wait(1).to({x:32.9,y:80.8},0).wait(1).to({y:81.1},0).wait(1).to({y:81.4},0).wait(1).to({y:81.2},0).wait(1).to({x:33,y:80.9},0).wait(1).to({y:80.8},0).wait(1).to({y:80.7},0).wait(1).to({y:80.6},0).wait(1).to({y:80.5},0).wait(1).to({y:80.4},0).wait(1).to({y:80.3},0).wait(1).to({y:80.2},0).wait(1).to({y:80},0).wait(1).to({y:79.9},0).wait(1).to({y:79.8},0).wait(1).to({y:79.7},0).wait(1).to({y:79.6},0).wait(1).to({y:79.5},0).wait(1).to({y:79.4},0).wait(1));
