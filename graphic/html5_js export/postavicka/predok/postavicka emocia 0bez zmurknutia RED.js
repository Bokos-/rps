...
// stage content:
(lib.postvickaanimaciaemocia0bezzmurknutiaRED = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer 22
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0066").s().p("");
