...
// stage content:
(lib.duelanimbluewinscissors = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(1).to({regX:108.5,regY:67.5,rotation:1.5,x:228.2,y:287.2,alpha:0.876},0).wait(1).to({rotation:1.8,x:210.7,y:283.3,alpha:0.965},0).wait(1).to({rotation:2.2,x:195.5,y:279.6,alpha:0.991},0).wait(1).to({rotation:2.8,x:182.4,y:276.1,alpha:1},0).wait(1).to({rotation:3.6,x:171.3,y:272.9},0).wait(1).to({rotation:4.5,x:161.9,y:270.1},0).wait(1).to({rotation:5.7,x:153.9,y:267.3},0).wait(1).to({rotation:7.1,x:147.4,y:264.9},0).wait(1).to({rotation:8.8,x:142,y:262.6},0).wait(1).to({rotation:11,x:137.6,y:260.5},0).wait(1).to({rotation:12.8,x:134.2,y:258.8},0).wait(1).to({rotation:13.6,x:131.3,y:257.2},0).wait(1).to({rotation:13.8,x:129.1,y:255.8},0).wait(1).to({x:127.2,y:254.5},0).wait(1).to({x:125.9,y:253.5},0).wait(1).to({rotation:13.7,x:124.9,y:252.6},0).wait(1).to({x:124.6,y:252.4},0).wait(1).to({x:124.4,y:252.1},0).wait(1).to({rotation:13.6,x:124.3,y:252},0).wait(1).to({x:124.2,y:251.8},0).wait(1).to({rotation:13.5,x:124.1,y:251.6},0).wait(1).to({rotation:13.4,x:123.9,y:251.5},0).wait(1).to({rotation:13.3,x:123.8,y:251.3},0).wait(1).to({rotation:13.2,x:123.7,y:251.1},0).wait(1).to({rotation:13,x:123.6,y:250.9},0).wait(1).to({rotation:12.9,x:123.5,y:250.6},0).wait(1).to({rotation:12.7,x:123.4,y:250.4},0).wait(1).to({rotation:12.5,x:123.3,y:250.1},0).wait(1).to({rotation:12.3,x:123.2,y:249.8},0).wait(1).to({rotation:12,x:123.1,y:249.4},0).wait(1).to({rotation:11.6,x:123,y:248.9},0).wait(1).to({rotation:11.3,y:248.3},0).wait(1).to({rotation:10.8,y:247.6},0).wait(1).to({rotation:10.2,x:123.1,y:246.6},0).wait(1).to({rotation:9.6,x:123.3,y:245.5},0).wait(1).to({rotation:8.9,x:123.6,y:244.2},0).wait(1).to({rotation:8.1,x:124.1,y:242.6},0).wait(1).to({rotation:7.2,x:124.9,y:240.8},0).wait(1).to({rotation:6.3,x:125.9,y:238.7},0).wait(1).to({rotation:5.3,x:127.2,y:236.4},0).wait(1).to({rotation:4.3,x:128.9,y:233.7},0).wait(1).to({rotation:3.2,x:131,y:230.6,alpha:0.93},0).wait(1).to({rotation:2,x:133.6,y:227.3,alpha:0.765},0).wait(1).to({rotation:0.8,x:136.7,y:223.5,alpha:0},0).wait(1));
