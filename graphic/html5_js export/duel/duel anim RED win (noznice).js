...
lib.properties = {
	...
	manifest: [
		...
		{src:"duel (png)/cikcak.png", id:"cikcak"},
		{src:"duel (png)/efektblueflip.png", id:"efektblueflip"},
		{src:"duel (png)/efektredflip.png", id:"efektredflip"},
		...
		{src:"duel (png)/noznicaspodok.png", id:"noznicaspodok"},
		{src:"duel (png)/noznicavrch.png", id:"noznicavrch"},
		...
		{src:"duel (png)/papiercast1.png", id:"papiercast1"},
		{src:"duel (png)/papiercast2.png", id:"papiercast2"},
		{src:"duel (png)/papiercast3.png", id:"papiercast3"},
		...
		{src:"duel (png)/xmove_0000_redruka.png", id:"xmove_0000_redruka"},
		{src:"duel (png)/xmove_0001_redplas.png", id:"xmove_0001_redplas"},
		{src:"duel (png)/xmove_0002_vnutorplastred.png", id:"xmove_0002_vnutorplastred"},
		{src:"duel (png)/xmove_0003_COPred.png", id:"xmove_0003_COPred"},
		{src:"duel (png)/xmove_0004_blueruka.png", id:"xmove_0004_blueruka"},
		{src:"duel (png)/xmove_0005_blueplast.png", id:"xmove_0005_blueplast"},
		{src:"duel (png)/xmove_0006_vnutorplastblue.png", id:"xmove_0006_vnutorplastblue"},
		{src:"duel (png)/xmove_0007_COPblue.png", id:"xmove_0007_COPblue"}
	]
};
...
(lib.cikcak = function() {
	this.initialize(img.cikcak);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,396,348);


(lib.efektblueflip = function() {
	this.initialize(img.efektblueflip);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,350,274);


(lib.efektredflip = function() {
	this.initialize(img.efektredflip);
}).prototype = p = new cjs.Bitmap();
...
(lib.noznicaspodok = function() {
	this.initialize(img.noznicaspodok);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,197,66);


(lib.noznicavrch = function() {
	this.initialize(img.noznicavrch);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,250,67);
...
(lib.papiercast1 = function() {
	this.initialize(img.papiercast1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,150,102);


(lib.papiercast2 = function() {
	this.initialize(img.papiercast2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,130,108);


(lib.papiercast3 = function() {
	this.initialize(img.papiercast3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,90,55);
...
(lib.xmove_0000_redruka = function() {
	this.initialize(img.xmove_0000_redruka);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,364,284);


(lib.xmove_0001_redplas = function() {
	this.initialize(img.xmove_0001_redplas);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,242,180);


(lib.xmove_0002_vnutorplastred = function() {
	this.initialize(img.xmove_0002_vnutorplastred);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,217,135);


(lib.xmove_0003_COPred = function() {
	this.initialize(img.xmove_0003_COPred);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,277,100);


(lib.xmove_0004_blueruka = function() {
	this.initialize(img.xmove_0004_blueruka);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,364,284);


(lib.xmove_0005_blueplast = function() {
	this.initialize(img.xmove_0005_blueplast);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,242,180);


(lib.xmove_0006_vnutorplastblue = function() {
	this.initialize(img.xmove_0006_vnutorplastblue);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,217,134);


(lib.xmove_0007_COPblue = function() {
	this.initialize(img.xmove_0007_COPblue);
}).prototype = p = new cjs.Bitmap();
...
(lib.Symbol77 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.cikcak();
	this.instance.setTransform(16.5,15.3,0.71,0.71);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(16.5,15.3,281.2,247.1);
...
(lib.Symbol76 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.papiercast3();
	this.instance.setTransform(0,0,0.483,0.483);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,43.5,26.6);
...
(lib.Symbol75 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.papiercast2();
	this.instance.setTransform(0,0,0.562,0.561);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,73,60.7);
...
(lib.Symbol74 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.papiercast1();
	this.instance.setTransform(0,0,0.562,0.561);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,84.3,57.3);
...
(lib.Symbol72 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.noznicaspodok();
	this.instance.setTransform(115.4,32.6,0.565,0.565,151);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,115.4,86.5);
...
(lib.Symbol71 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.noznicavrch();
	this.instance.setTransform(141.8,33.1,0.565,0.565,151);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,141.8,101.5);
...
(lib.Symbol66 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.efektblueflip();
	this.instance.setTransform(-4.6,5.4,0.469,0.469,-4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-4.6,-6,172.6,139.6);
...
(lib.Symbol65 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.efektredflip();
	this.instance.setTransform(5.7,13.1,0.491,0.491,-1.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(5.7,7.6,176.1,140.5);
...
(lib.Symbol61 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.xmove_0007_COPblue();
...
(lib.Symbol39 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.xmove_0006_vnutorplastblue();
...
(lib.Symbol38 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.xmove_0005_blueplast();
...
(lib.Symbol37 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.xmove_0004_blueruka();
...
(lib.Symbol32 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.xmove_0003_COPred();
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.xmove_0002_vnutorplastred();
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.xmove_0001_redplas();
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.xmove_0000_redruka();
...
// stage content:
(lib.duelanimredwinscissors = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// zikzak
	this.instance = new lib.Symbol77();
	this.instance.setTransform(169,251.1,0.858,0.858,0,0,0,129.3,120.6);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:157,regY:138.8,x:192.7,y:266.7},0).wait(21).to({x:198.7,y:268.5,alpha:0.5},0).wait(1).to({x:204.6,y:270.3,alpha:1},0).wait(1).to({x:210.6,y:272.1,alpha:0.958},0).wait(1).to({x:216.6,y:273.8,alpha:0.845},0).wait(1).to({x:222.7,y:275.5,alpha:0.357},0).wait(1).to({x:228.7,y:277.1,alpha:0.173},0).wait(1).to({x:234.7,y:278.5,alpha:0.108},0).wait(1).to({x:240.7,y:279.6,alpha:0.062},0).wait(1).to({alpha:0.028},0).wait(1).to({alpha:0.003},0).wait(14));

	// Symbol 76
	this.instance_1 = new lib.Symbol76();
	this.instance_1.setTransform(154,265,0.693,0.837,0,0,0,21.6,13.2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(22).to({_off:false},0).wait(1).to({regX:21.7,regY:13.3,rotation:-3.4,x:170.2,y:269.5},0).wait(1).to({rotation:-6.8,x:186.8,y:272.7},0).wait(1).to({rotation:-10.2,x:203.5,y:273.9},0).wait(1).to({rotation:-13.6,x:220.1,y:271.6},0).wait(1).to({rotation:-17,x:223.4,y:270.3},0).wait(1).to({rotation:-20.5,x:226.8,y:268.9,alpha:0.979},0).wait(1).to({rotation:-23.9,x:230.1,y:267.4,alpha:0.953},0).wait(1).to({rotation:-27.3,x:233.5,y:265.9,alpha:0.921},0).wait(1).to({rotation:-30.7,x:236.9,y:264.5,alpha:0.882},0).wait(1).to({rotation:-34.1,x:238.2,y:263.6,alpha:0.833},0).wait(1).to({rotation:-37.5,x:239.8,y:263,alpha:0.769},0).wait(1).to({rotation:-40.9,x:241.3,y:262.6,alpha:0.671},0).wait(1).to({rotation:-44.3,x:242.9,y:262.5,alpha:0.548},0).wait(1).to({rotation:-47.7,x:244.5,y:263,alpha:0.439},0).wait(1).to({rotation:-51.1,x:245.8,y:263.9,alpha:0.34},0).wait(1).to({rotation:-54.5,x:246.8,y:264.9,alpha:0.251},0).wait(1).to({rotation:-58,x:247.9,y:266.4,alpha:0.171},0).wait(1).to({rotation:-61.4,x:248.1,y:269.6,alpha:0.104},0).wait(1).to({rotation:-64.8,x:246.9,y:272.4,alpha:0.05},0).wait(1).to({rotation:-68.2,x:245.2,y:275,alpha:0.014},0).wait(1).to({rotation:-71.6,x:243.1,y:277.4,alpha:0},0).wait(1).to({rotation:-75,x:240.8,y:279.6},0).wait(1));

	// Symbol 75
	this.instance_2 = new lib.Symbol75();
	this.instance_2.setTransform(122.9,235.7,0.693,0.837,0,0,0,36.5,30.2);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(22).to({_off:false},0).wait(1).to({regY:30.3,rotation:-2.2,x:145.2,y:238.2},0).wait(1).to({rotation:-4.4,x:167.6,y:239.3},0).wait(1).to({rotation:-6.6,x:190,y:238},0).wait(1).to({rotation:-8.8,x:192.9,y:237.5},0).wait(1).to({rotation:-11,x:195.4,y:237},0).wait(1).to({rotation:-13.2,x:198,y:236.5,alpha:0.988},0).wait(1).to({rotation:-15.4,x:200.7,y:235.9,alpha:0.97},0).wait(1).to({rotation:-17.6,x:203.3,y:235.4,alpha:0.946},0).wait(1).to({rotation:-19.8,x:205.9,y:234.7,alpha:0.914},0).wait(1).to({rotation:-22,x:208.5,y:234,alpha:0.874},0).wait(1).to({rotation:-24.2,x:210.3,y:233.4,alpha:0.821},0).wait(1).to({rotation:-26.4,x:212.1,y:233.1,alpha:0.75},0).wait(1).to({rotation:-28.6,x:213.9,y:233.2,alpha:0.641},0).wait(1).to({rotation:-30.8,x:215.6,y:233.9,alpha:0.511},0).wait(1).to({rotation:-33,x:216.8,y:235.2,alpha:0.4},0).wait(1).to({rotation:-35.2,x:216.7,y:239.7,alpha:0.303},0).wait(1).to({rotation:-37.4,x:214.4,y:243.5,alpha:0.216},0).wait(1).to({rotation:-39.7,x:211.3,y:246.7,alpha:0.14},0).wait(1).to({rotation:-41.9,x:207.9,y:249.6,alpha:0.075},0).wait(1).to({rotation:-44.1,x:204.3,y:252.3,alpha:0.024},0).wait(1).to({rotation:-46.3,x:200.6,y:254.7,alpha:0},0).wait(1).to({rotation:-48.5,x:196.8,y:257},0).wait(1));

	// Symbol 74
	this.instance_3 = new lib.Symbol74();
	this.instance_3.setTransform(190.8,295.6,0.693,0.837,0,0,0,42.1,28.6);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(22).to({_off:false},0).wait(1).to({rotation:-4.8,x:214,y:310.1},0).wait(1).to({rotation:-9.5,x:240.2,y:318},0).wait(1).to({rotation:-14.3,x:243.6},0).wait(1).to({rotation:-19.1,x:247,y:317.9},0).wait(1).to({rotation:-23.9,x:250.7,y:317.6,alpha:0.993},0).wait(1).to({rotation:-28.6,x:253.9,y:317.2,alpha:0.983},0).wait(1).to({rotation:-33.4,x:257.2,y:316.6,alpha:0.97},0).wait(1).to({rotation:-38.2,x:260.5,y:315.5,alpha:0.954},0).wait(1).to({rotation:-43,x:263.3,y:313.7,alpha:0.933},0).wait(1).to({rotation:-47.7,x:263.5,y:310.5,alpha:0.907},0).wait(1).to({rotation:-52.5,x:265.1,y:310.9,alpha:0.873},0).wait(1).to({rotation:-57.3,x:266.5,y:311.8,alpha:0.825},0).wait(1).to({rotation:-62,x:267.6,y:313.2,alpha:0.737},0).wait(1).to({rotation:-66.8,x:268.5,y:314.6,alpha:0.592},0).wait(1).to({rotation:-71.6,x:268.8,y:317.2,alpha:0.454},0).wait(1).to({rotation:-76.4,x:268.1,y:319.8,alpha:0.327},0).wait(1).to({rotation:-81.1,x:267,y:322.3,alpha:0.214},0).wait(1).to({rotation:-85.9,x:265.7,y:324.7,alpha:0.122},0).wait(1).to({rotation:-90.7,x:264.2,y:327,alpha:0.054},0).wait(1).to({rotation:-95.5,x:262.7,y:329.2,alpha:0.013},0).wait(1).to({rotation:-100.2,x:261,y:331.4,alpha:0},0).wait(1).to({rotation:-105,x:259.3,y:333.5},0).wait(1));

	// noznice vrch
	this.instance_4 = new lib.Symbol71();
	this.instance_4.setTransform(571.4,72.6,1.1,1.103,0,0,0,66.1,39.4);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regX:70.9,regY:50.7,x:546.4,y:100.9},0).wait(1).to({rotation:0.1,x:517.7,y:115.9},0).wait(1).to({x:490.6,y:130.1},0).wait(1).to({x:465,y:143.5},0).wait(1).to({x:440.7,y:156.2,alpha:0.029},0).wait(1).to({rotation:0.2,x:417.8,y:168.2,alpha:0.121},0).wait(1).to({x:396.2,y:179.6,alpha:0.291},0).wait(1).to({x:375.8,y:190.3,alpha:0.561},0).wait(1).to({x:356.4,y:200.4,alpha:1},0).wait(1).to({rotation:0.3,x:338.7,y:210.3},0).wait(1).to({x:321.9,y:219.8},0).wait(1).to({x:306.2,y:228.7},0).wait(1).to({rotation:9.9,x:289.1,y:237.8},0).wait(1).to({rotation:14.4,x:274,y:246},0).wait(1).to({rotation:11.3,x:261.4,y:253.4},0).wait(1).to({rotation:0.1,x:249.3,y:260.9},0).wait(1).to({rotation:0.1,x:232.4,y:270.4},0).wait(1).to({x:216.4,y:279.5},0).wait(1).to({rotation:12.5,x:198.3,y:289},0).wait(1).to({rotation:19,x:182.3,y:297.4},0).wait(1).to({rotation:17,x:169,y:305.1},0).wait(1).to({rotation:12.1,x:157,y:312.4},0).wait(1).to({rotation:0.4,x:147.1,y:318.7},0).wait(1).to({rotation:0.4,x:135.1,y:325.5},0).wait(1).to({x:123.5,y:332.1},0).wait(1).to({x:112.4,y:338.3},0).wait(1).to({x:101.7,y:344.4},0).wait(1).to({x:91.3,y:350.3},0).wait(1).to({x:81.3,y:356,alpha:0.728},0).wait(1).to({x:71.5,y:361.5,alpha:0.483},0).wait(1).to({x:62,y:366.9,alpha:0.269},0).wait(1).to({x:52.6,y:372.2,alpha:0.141},0).wait(1).to({x:43.4,y:377.4,alpha:0.064},0).wait(1).to({x:34.4,y:382.5,alpha:0.009},0).wait(1).to({x:25.5,y:387.5},0).wait(1).to({x:16.7,y:392.5},0).wait(1).to({x:7.9,y:397.5},0).wait(1).to({x:-0.7,y:402.4},0).wait(1).to({x:-9.4,y:407.2},0).wait(1).to({x:-18,y:412.1},0).wait(1).to({x:-26.5,y:417},0).wait(1).to({x:-35.1,y:421.8},0).wait(1).to({x:-43.7,y:426.7},0).wait(1).to({x:-52.3,y:431.5},0).wait(1));

	// noznice spodok
	this.instance_5 = new lib.Symbol72();
	this.instance_5.setTransform(564.1,67.8,1.1,1.103,0,0,0,57.7,43.3);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1).to({regY:43.2,x:535.3,y:83},0).wait(1).to({x:508.1,y:97.6},0).wait(1).to({x:482.3,y:111.4},0).wait(1).to({x:458,y:124.4},0).wait(1).to({x:434.9,y:136.7,alpha:0.053},0).wait(1).to({x:413.2,y:148.3,alpha:0.193},0).wait(1).to({x:392.6,y:159.3,alpha:0.401},0).wait(1).to({x:373.2,y:169.7,alpha:0.67},0).wait(1).to({x:354.9,y:179.5,alpha:1},0).wait(1).to({x:337.6,y:188.8},0).wait(1).to({x:321.2,y:197.5},0).wait(1).to({x:305.8,y:205.8},0).wait(1).to({rotation:-13.9,x:290.8,y:213.8},0).wait(1).to({rotation:-19.5,x:272,y:224.4},0).wait(1).to({rotation:-13.7,x:254.3,y:234.5},0).wait(1).to({rotation:0,x:237,y:244.3},0).wait(1).to({x:219.9,y:254},0).wait(1).to({x:203.6,y:263.2},0).wait(1).to({rotation:-17,x:188.1,y:271.9},0).wait(1).to({rotation:-29.9,x:173.4,y:280.3},0).wait(1).to({rotation:-25.9,x:159.5,y:288.2},0).wait(1).to({rotation:-19.4,x:146.2,y:295.7},0).wait(1).to({rotation:-0.9,x:133.5,y:302.9},0).wait(1).to({rotation:-0.9,x:121.3,y:309.8},0).wait(1).to({x:109.6,y:316.4},0).wait(1).to({x:98.3,y:322.8},0).wait(1).to({x:87.5,y:328.9},0).wait(1).to({x:76.9,y:334.9,alpha:0.667},0).wait(1).to({x:66.8,y:340.7,alpha:0.369},0).wait(1).to({x:56.9,y:346.3,alpha:0.132},0).wait(1).to({x:47.2,y:351.8,alpha:0.064},0).wait(1).to({x:37.7,y:357.1,alpha:0.036},0).wait(1).to({x:28.4,y:362.4,alpha:0.017},0).wait(1).to({x:19.3,y:367.6,alpha:0.006},0).wait(1).to({x:10.3,y:372.7},0).wait(1).to({x:1.3,y:377.7},0).wait(1).to({x:-7.5,y:382.8},0).wait(1).to({x:-16.3,y:387.7},0).wait(1).to({x:-25.1,y:392.7},0).wait(1).to({x:-33.8,y:397.6},0).wait(1).to({x:-42.5,y:402.6},0).wait(1).to({x:-51.2,y:407.5},0).wait(1).to({x:-59.8,y:412.4},0).wait(1).to({x:-68.5,y:417.3},0).wait(1));

	//  dual papier
	this.instance_6 = new lib.Symbol2();
	this.instance_6.setTransform(216.6,267.9,0.298,0.298,0,0,0,205.3,151);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({regX:206.5,regY:151.5,x:187.2,y:243.7,alpha:0.448},0).wait(1).to({rotation:-0.1,x:155.6,y:222.2,alpha:0.8},0).wait(1).to({x:148.3,y:219.6,alpha:0.936},0).wait(1).to({x:134.1,y:217.6,alpha:1},0).wait(1).to({x:119.7,y:217.7},0).wait(1).to({rotation:12.2,x:105.4,y:220.3},0).wait(1).to({rotation:25.7,x:92.8,y:230.1},0).wait(1).to({rotation:40.5,x:95.2,y:239},0).wait(1).to({rotation:56.4,x:98.7,y:240.8},0).wait(1).to({rotation:73.8,x:102.2,y:242.6},0).wait(1).to({rotation:92.7,x:105.6,y:244.3},0).wait(1).to({rotation:113.8,x:109,y:246.1},0).wait(1).to({rotation:137.5,x:112.5,y:247.8},0).wait(1).to({rotation:165.1,x:115.9,y:249.5},0).wait(1).to({rotation:199.2,x:119.6,y:251.3},0).wait(1).to({rotation:245.1,x:123.3,y:253.1},0).wait(1).to({rotation:303,x:127.1,y:255.3},0).wait(1).to({rotation:371.2,x:130.5,y:257.8},0).wait(1).to({rotation:447.6,x:140.1,y:261.9},0).wait(1).to({rotation:529.5,x:150,y:265.1},0).wait(1).to({rotation:613.8,x:160.6,y:268.4},0).wait(1).to({rotation:697.7,x:171.1,y:272.3,alpha:0.001},0).wait(1).to({rotation:778.5,x:181,y:276},0).wait(1).to({rotation:853.7,x:190.9,y:279.2},0).wait(1).to({rotation:921.8,x:201.2,y:282.1},0).wait(1).to({rotation:981.4,x:211.9,y:285.3},0).wait(1).to({rotation:1031.9,x:222.4,y:288.9},0).wait(1).to({rotation:1072.9,x:232.6,y:292.4},0).wait(1).to({rotation:1104.4,x:242.8,y:295.8},0).wait(1).to({rotation:1128.9,x:253,y:299.2},0).wait(1).to({rotation:1148.6,x:263.1,y:302.4},0).wait(1).to({rotation:1164.9,x:273.3,y:305.6},0).wait(1).to({rotation:1178.5,x:283.5,y:308.7},0).wait(1).to({rotation:1189.9,x:293.8,y:311.9},0).wait(1).to({rotation:1199.4,x:304,y:315.1},0).wait(1).to({rotation:1207.4,x:314.3,y:318.2},0).wait(1).to({rotation:1213.9,x:324.6,y:321.3},0).wait(1).to({rotation:1219.2,x:334.9,y:324.5},0).wait(1).to({rotation:1223.4,x:345.2,y:327.6},0).wait(1).to({rotation:1226.6,x:355.5,y:330.7},0).wait(1).to({rotation:1228.7,x:365.8,y:333.8},0).wait(1).to({rotation:1229.9,x:376.1,y:337},0).wait(1).to({rotation:1230,x:386.4,y:340.1},0).wait(1).to({rotation:1229,x:386.5},0).wait(1));

	// vir
	this.instance_7 = new lib.Symbol67();
	this.instance_7.setTransform(128.9,256.8,0.298,0.298,0,0,0,170.6,138.3);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({regX:172.7,regY:143.9,rotation:-1.5,x:129.7,y:258.6,alpha:0.001},0).wait(1).to({rotation:-1.7,x:129.8,y:258.7},0).wait(1).to({rotation:-1,x:129.9,y:258.8},0).wait(1).to({rotation:0.5,x:130,y:258.9},0).wait(1).to({rotation:2.8,y:259},0).wait(1).to({rotation:5.8,y:259.1},0).wait(1).to({rotation:9.5,y:259.3},0).wait(1).to({rotation:13.9,y:259.4},0).wait(1).to({rotation:18.9,x:129.9,y:259.5},0).wait(1).to({rotation:24.6,x:129.8,y:259.6},0).wait(1).to({rotation:30.9,y:259.7},0).wait(1).to({rotation:37.9,x:129.7},0).wait(1).to({rotation:45.5,x:129.5},0).wait(1).to({rotation:53.9,x:129.4},0).wait(1).to({rotation:62.9,x:129.3},0).wait(1).to({rotation:72.5,x:129.2,y:259.6},0).wait(1).to({rotation:82.9,x:129.1,y:259.4},0).wait(1).to({rotation:94,y:259.2},0).wait(1).to({rotation:105.7,y:259,alpha:0.041},0).wait(1).to({rotation:124,x:138,y:260.9,alpha:0.176},0).wait(1).to({rotation:157.6,x:147.3,y:262.4,alpha:0.448},0).wait(1).to({rotation:213.8,x:157.8,y:264.5,alpha:0.99},0).wait(1).to({rotation:307.1,x:167.9,y:269.1,alpha:0.73},0).wait(1).to({rotation:470.5,x:173.2,y:271.1,alpha:0.471},0).wait(1).to({rotation:391.9,x:183.4,y:275.3,alpha:0.344},0).wait(1).to({rotation:269.6,x:194.3,alpha:0.254},0).wait(1).to({rotation:375,x:201.6,y:280.2,alpha:0.183},0).wait(1).to({rotation:424.1,x:209.1,y:282.1,alpha:0.128},0).wait(1).to({rotation:454.8,x:217.4,y:283.8,alpha:0.085},0).wait(1).to({rotation:476.2,x:226.2,y:285.6,alpha:0.053},0).wait(1).to({rotation:491.8,x:235,y:287.6,alpha:0.029},0).wait(1).to({rotation:503.3,x:244,y:289.7,alpha:0.012},0).wait(1).to({rotation:511.7,x:253,y:292,alpha:0.003},0).wait(1).to({rotation:517.5,x:262,y:294.3,alpha:0},0).wait(1).to({rotation:521.3,x:270.9,y:296.7},0).wait(1).to({rotation:523.3,x:279.8,y:299.1},0).wait(1).to({rotation:523.8,x:288.6,y:301.5},0).wait(1).to({rotation:522.9,x:297.4,y:304},0).wait(1).to({rotation:520.8,x:306.1,y:306.6},0).wait(1).to({rotation:517.6,x:314.9,y:309.1},0).wait(1).to({rotation:513.3,x:323.6,y:311.6},0).wait(1).to({rotation:508,x:323.5,y:311.7},0).wait(1).to({rotation:501.7,x:323.4,y:311.9},0).wait(1).to({rotation:494,x:323.3,y:312.1},0).wait(1));

	// bota 1
	this.instance_8 = new lib.Symbol3();
	this.instance_8.setTransform(268,303.8,0.298,0.298,0,0,0,14.5,15);
	this.instance_8.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({x:289.3,y:290.5,alpha:0.8},0).wait(1).to({x:307.6,y:278.8,alpha:0.916},0).wait(1).to({x:323.5,y:268.4,alpha:0.973},0).wait(1).to({x:337,y:259.3,alpha:1},0).wait(1).to({x:348.6,y:251.3},0).wait(1).to({x:358.3,y:244.3},0).wait(1).to({x:366.3,y:238.3},0).wait(1).to({x:373,y:233},0).wait(1).to({x:378.5,y:228.5},0).wait(1).to({x:382.9,y:224.5},0).wait(1).to({x:386.3,y:221.1},0).wait(1).to({x:388.8,y:218},0).wait(1).to({x:389.9,y:216.4},0).wait(1).to({x:390.1,y:216},0).wait(1).to({x:390.3,y:215.8},0).wait(1).to({x:390.4,y:215.6},0).wait(1).to({x:390.5,y:215.4},0).wait(1).to({y:215.2},0).wait(1).to({x:390.6,y:215.1},0).wait(1).to({x:390.7,y:214.9},0).wait(1).to({y:214.8},0).wait(1).to({x:390.8,y:214.7},0).wait(1).to({x:390.9,y:214.5},0).wait(1).to({y:214.4},0).wait(1).to({x:391,y:214.2},0).wait(1).to({x:391.1,y:214.1},0).wait(1).to({x:391.2,y:213.9},0).wait(1).to({y:213.7},0).wait(1).to({x:391.3,y:213.5},0).wait(1).to({x:391.5,y:213.2},0).wait(1).to({x:391.6,y:212.9},0).wait(1).to({x:391.8,y:212.5},0).wait(1).to({x:392,y:212},0).wait(1).to({x:392.2,y:211.4},0).wait(1).to({x:392.5,y:210.7},0).wait(1).to({x:392.8,y:209.8},0).wait(1).to({x:393,y:208.7},0).wait(1).to({x:393.3,y:207.4},0).wait(1).to({x:393.4,y:205.8},0).wait(1).to({x:393.1,y:203.9},0).wait(1).to({x:391.8,y:202.2,alpha:0.986},0).wait(1).to({x:389.4,y:201.3,alpha:0.945},0).wait(1).to({x:386.5,alpha:0.834},0).wait(1).to({x:383.2,y:202.1,alpha:0},0).wait(1));

	// bota 0
	this.instance_9 = new lib.Symbol4();
	this.instance_9.setTransform(234,305.8,0.298,0.298,0,0,0,19.3,20);
	this.instance_9.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({regX:19.5,x:252.2,y:288.2,alpha:0.8},0).wait(1).to({x:267.8,y:272.7,alpha:0.916},0).wait(1).to({x:281.3,y:259.1,alpha:0.973},0).wait(1).to({x:292.6,y:247.1,alpha:1},0).wait(1).to({x:302.1,y:236.5},0).wait(1).to({x:304,y:234.1},0).wait(1).to({x:304.9,y:232.9},0).wait(1).to({x:305.7,y:231.9},0).wait(1).to({x:306.3,y:231},0).wait(1).to({x:306.8,y:230.3},0).wait(1).to({x:307.2,y:229.7},0).wait(1).to({x:307.6,y:229.2},0).wait(1).to({x:307.8,y:228.8},0).wait(1).to({x:308.1,y:228.5},0).wait(1).to({x:308.2,y:228.2},0).wait(1).to({x:308.4,y:228},0).wait(1).to({x:308.5,y:227.8},0).wait(1).to({x:308.6,y:227.6},0).wait(1).to({x:308.7,y:227.4},0).wait(1).to({x:308.8,y:227.3},0).wait(1).to({x:308.9,y:227.1},0).wait(1).to({x:309,y:227},0).wait(1).to({x:309.1,y:226.9},0).wait(1).to({x:309.2,y:226.7},0).wait(1).to({x:309.3,y:226.6},0).wait(1).to({x:309.4,y:226.4},0).wait(1).to({x:309.5,y:226.2},0).wait(1).to({x:309.7,y:226},0).wait(1).to({x:309.8,y:225.8},0).wait(1).to({x:310,y:225.5},0).wait(1).to({x:310.2,y:225.2},0).wait(1).to({x:310.4,y:224.8},0).wait(1).to({x:310.8,y:224.3},0).wait(1).to({x:311.1,y:223.6},0).wait(1).to({x:311.6,y:222.9},0).wait(1).to({x:312.1,y:222},0).wait(1).to({x:312.8,y:220.8},0).wait(1).to({x:313.5,y:219.5},0).wait(1).to({x:314.3,y:217.9},0).wait(1).to({x:315.3,y:216},0).wait(1).to({x:316.3,y:213.7,alpha:0.986},0).wait(1).to({x:317.3,y:211,alpha:0.945},0).wait(1).to({x:318.3,y:207.9,alpha:0.834},0).wait(1).to({x:319,y:204.1,alpha:0},0).wait(1));

	// Layer 8
	this.instance_10 = new lib.Symbol5();
	this.instance_10.setTransform(261.5,295.1,0.297,0.297,-49.9,0,0,158.2,137.1);
	this.instance_10.alpha = 0.02;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1).to({regX:182,regY:142,scaleX:0.3,scaleY:0.3,rotation:-46.8,x:284.1,y:278.7,alpha:0.464},0).wait(1).to({rotation:-44.2,x:298.7,y:268,alpha:0.814},0).wait(1).to({rotation:-41.6,x:311.1,y:258.4,alpha:0.946},0).wait(1).to({rotation:-38.6,x:321.7,y:250.1,alpha:1},0).wait(1).to({rotation:-34.1,x:330.7,y:242.9},0).wait(1).to({rotation:-27.2,x:338.2,y:236.9},0).wait(1).to({rotation:-16.3,x:344.1,y:232.2},0).wait(1).to({rotation:-6.3,x:348.5,y:228},0).wait(1).to({rotation:-2.3,x:349.4,y:226.9},0).wait(1).to({rotation:-1.3,x:349.8,y:226.2},0).wait(1).to({rotation:-1.7,x:350.2,y:225.4},0).wait(1).to({rotation:-2.5,x:350.5,y:224.8},0).wait(1).to({rotation:-3.2,x:350.8,y:224.2},0).wait(1).to({rotation:-3.7,x:351,y:223.8},0).wait(1).to({rotation:-4.2,x:351.2,y:223.4},0).wait(1).to({rotation:-4.6,x:351.3,y:223.1},0).wait(1).to({rotation:-4.8,x:351.4,y:222.9},0).wait(1).to({rotation:-5,x:351.5,y:222.6},0).wait(1).to({rotation:-5.2,x:351.6,y:222.4},0).wait(1).to({x:351.7,y:222.2},0).wait(1).to({x:351.8,y:222.1},0).wait(1).to({x:351.9,y:221.9},0).wait(1).to({rotation:-5.1,x:352,y:221.7},0).wait(1).to({rotation:-4.9,y:221.6},0).wait(1).to({rotation:-4.7,x:352.1,y:221.5},0).wait(1).to({rotation:-4.5,x:352.2,y:221.3},0).wait(1).to({rotation:-4.2,x:352.3,y:221.1},0).wait(1).to({rotation:-3.9,x:352.4,y:221},0).wait(1).to({rotation:-3.6,x:352.5,y:220.8},0).wait(1).to({rotation:-3.2,x:352.6,y:220.5},0).wait(1).to({rotation:-2.8,x:352.9,y:220.2},0).wait(1).to({rotation:-2.3,x:353,y:219.7},0).wait(1).to({rotation:-1.8,x:353.3,y:219.2},0).wait(1).to({rotation:-1.3,x:353.6,y:218.6},0).wait(1).to({rotation:-0.7,x:354,y:217.8},0).wait(1).to({rotation:-0.2,x:354.4,y:216.8},0).wait(1).to({rotation:0.5,x:354.9,y:215.6},0).wait(1).to({rotation:1.1,x:355.5,y:214.1},0).wait(1).to({rotation:1.8,x:356.1,y:212.3},0).wait(1).to({rotation:2.5,x:356.9,y:210.3},0).wait(1).to({rotation:3.2,x:357.6,y:207.7,alpha:0.986},0).wait(1).to({rotation:4,x:358.3,y:204.9,alpha:0.945},0).wait(1).to({rotation:4.8,x:358.9,y:201.4,alpha:0.834},0).wait(1).to({rotation:5.6,x:359.1,y:197.5,alpha:0},0).wait(1));

	// Layer 9
	this.instance_11 = new lib.Symbol7();
	this.instance_11.setTransform(261.7,293.3,0.298,0.298,0,0,0,120.2,89.7);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1).to({regX:121,regY:90,x:278.9,y:280.7,alpha:0.8},0).wait(1).to({x:293.4,y:269.4,alpha:0.916},0).wait(1).to({x:305.9,y:259.4,alpha:0.973},0).wait(1).to({x:316.4,y:250.5,alpha:1},0).wait(1).to({x:325.4,y:242.5},0).wait(1).to({x:332.7,y:235.6},0).wait(1).to({x:338.6,y:229.4},0).wait(1).to({x:343,y:223.8},0).wait(1).to({x:344,y:222.1},0).wait(1).to({x:344.4,y:221.3},0).wait(1).to({x:344.8,y:220.6},0).wait(1).to({x:345.1,y:220},0).wait(1).to({x:345.3,y:219.6},0).wait(1).to({x:345.5,y:219.2},0).wait(1).to({x:345.7,y:218.9},0).wait(1).to({x:345.8,y:218.6},0).wait(1).to({x:345.9,y:218.4},0).wait(1).to({x:346,y:218.2},0).wait(1).to({x:346.1,y:218},0).wait(1).to({x:346.2,y:217.9},0).wait(1).to({x:346.3,y:217.7},0).wait(1).to({x:346.4,y:217.5},0).wait(1).to({y:217.4},0).wait(1).to({x:346.5,y:217.2},0).wait(1).to({x:346.6,y:217},0).wait(1).to({x:346.7,y:216.8},0).wait(1).to({x:346.8,y:216.6},0).wait(1).to({x:346.9,y:216.4},0).wait(1).to({x:347,y:216.2},0).wait(1).to({x:347.2,y:215.8},0).wait(1).to({x:347.4,y:215.5},0).wait(1).to({x:347.6,y:215},0).wait(1).to({x:347.8,y:214.4},0).wait(1).to({x:348.2,y:213.7},0).wait(1).to({x:348.6,y:212.8},0).wait(1).to({x:349,y:211.7},0).wait(1).to({x:349.5,y:210.5},0).wait(1).to({x:350.1,y:208.9},0).wait(1).to({x:350.8,y:207.1},0).wait(1).to({x:351.5,y:204.9},0).wait(1).to({x:352.3,y:202.3,alpha:0.986},0).wait(1).to({x:353,y:199.3,alpha:0.945},0).wait(1).to({x:353.7,y:195.8,alpha:0.834},0).wait(1).to({x:353.9,y:191.7,alpha:0},0).wait(1));

	// vnutor  plast
	this.instance_12 = new lib.Symbol8();
	this.instance_12.setTransform(277,283,0.298,0.298,0,0,0,108.8,67.3);
	this.instance_12.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(1).to({regX:108.5,regY:67.5,rotation:-0.7,x:294,y:271.5,alpha:0.814},0).wait(1).to({rotation:-1.4,x:308.7,y:261.3,alpha:0.928},0).wait(1).to({rotation:-2.2,x:321.3,y:252.1,alpha:0.979},0).wait(1).to({rotation:-3,x:332,y:243.9,alpha:1},0).wait(1).to({rotation:-3.9,x:341.1,y:236.7},0).wait(1).to({rotation:-4.9,x:348.6,y:230.3},0).wait(1).to({rotation:-6,x:354.7,y:224.7},0).wait(1).to({rotation:-7.5,x:359.5,y:219.7},0).wait(1).to({rotation:-10.7,x:363.2,y:215.1},0).wait(1).to({rotation:-14.7,x:364.2,y:213.4},0).wait(1).to({rotation:-18.4,x:364.7,y:212.7},0).wait(1).to({rotation:-21.2,x:365,y:212.1},0).wait(1).to({rotation:-23.2,x:365.2,y:211.6},0).wait(1).to({rotation:-24,x:365.4,y:211.2},0).wait(1).to({rotation:-24.2,x:365.6,y:210.8},0).wait(1).to({rotation:-23.9,x:365.8,y:210.5},0).wait(1).to({rotation:-23.3,y:210.3},0).wait(1).to({rotation:-22.7,x:366,y:210.1},0).wait(1).to({rotation:-22,x:366.1,y:209.9},0).wait(1).to({rotation:-21.3,y:209.7},0).wait(1).to({rotation:-20.5,x:366.2,y:209.5},0).wait(1).to({rotation:-19.7,x:366.3,y:209.4},0).wait(1).to({rotation:-18.8,x:366.4,y:209.1},0).wait(1).to({rotation:-17.8,x:366.5,y:208.9},0).wait(1).to({rotation:-16.8,y:208.8},0).wait(1).to({rotation:-15.9,x:366.7,y:208.6},0).wait(1).to({rotation:-14.9,x:366.8,y:208.4},0).wait(1).to({rotation:-13.9,x:366.9,y:208.1},0).wait(1).to({rotation:-12.9,x:367,y:207.8},0).wait(1).to({rotation:-11.9,x:367.1,y:207.4},0).wait(1).to({rotation:-11,x:367.3,y:207.1},0).wait(1).to({rotation:-10,x:367.5,y:206.5},0).wait(1).to({rotation:-9.1,x:367.8,y:205.9},0).wait(1).to({rotation:-8.2,x:368.1,y:205.1},0).wait(1).to({rotation:-7.3,x:368.5,y:204.1},0).wait(1).to({rotation:-6.4,x:368.9,y:203},0).wait(1).to({rotation:-5.5,x:369.4,y:201.5},0).wait(1).to({rotation:-4.7,x:370,y:199.9},0).wait(1).to({rotation:-3.8,x:370.6,y:197.8},0).wait(1).to({rotation:-3,x:371.1,y:195.4},0).wait(1).to({rotation:-2.2,x:371.8,y:192.6,alpha:0.986},0).wait(1).to({rotation:-1.5,x:372.2,y:189.3,alpha:0.945},0).wait(1).to({rotation:-0.8,x:372.3,y:185.4,alpha:0.834},0).wait(1).to({rotation:-0.1,x:372,y:181,alpha:0},0).wait(1));

	// ruka zadna
	this.instance_13 = new lib.Symbol10();
	this.instance_13.setTransform(295.2,272.2,0.297,0.297,-55.4);
	this.instance_13.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(1).to({regX:31,regY:17.5,scaleX:0.3,scaleY:0.3,rotation:-56.1,x:322.7,y:254,alpha:0.448},0).wait(1).to({rotation:-56.3,x:338.1,y:241.9,alpha:0.8},0).wait(1).to({rotation:-55.9,x:351.3,y:231.2,alpha:0.936},0).wait(1).to({rotation:-55.2,x:362.5,y:221.8,alpha:1},0).wait(1).to({rotation:-54,x:372,y:213.5},0).wait(1).to({rotation:-52.4,x:379.7,y:206.1},0).wait(1).to({rotation:-50.5,x:385.6,y:199.4},0).wait(1).to({rotation:-48,x:387.2,y:197.6},0).wait(1).to({rotation:-43.2,x:388,y:197.4},0).wait(1).to({rotation:-12.1,x:388.3,y:202.3},0).wait(1).to({rotation:31.4,x:383.7,y:207.7},0).wait(1).to({rotation:36.2,x:383.2,y:207.6},0).wait(1).to({rotation:36.8,x:383.3,y:207.2},0).wait(1).to({rotation:37.2,x:383.4,y:206.8},0).wait(1).to({rotation:37.5,x:383.5,y:206.5},0).wait(1).to({rotation:37.7,x:383.6,y:206.3},0).wait(1).to({rotation:37.8,x:383.7,y:206.1},0).wait(1).to({rotation:37.9,x:383.8,y:205.9},0).wait(1).to({rotation:37.8,x:383.9,y:205.7},0).wait(1).to({rotation:37.6,x:384,y:205.6},0).wait(1).to({rotation:37.4,x:384.2,y:205.4},0).wait(1).to({rotation:37,y:205.2},0).wait(1).to({rotation:36.5,x:384.4,y:205},0).wait(1).to({rotation:35.9,x:384.6,y:204.7},0).wait(1).to({rotation:35.1,x:384.8,y:204.5},0).wait(1).to({rotation:34.2,x:385.1,y:204.3},0).wait(1).to({rotation:33.2,x:385.3,y:204},0).wait(1).to({rotation:32,x:385.6,y:203.7},0).wait(1).to({rotation:30.5,x:386,y:203.3},0).wait(1).to({rotation:28.9,x:386.4,y:202.8},0).wait(1).to({rotation:27,x:386.8,y:202.3},0).wait(1).to({rotation:24.8,x:387.4,y:201.6},0).wait(1).to({rotation:22.3,x:388,y:200.7},0).wait(1).to({rotation:19.5,x:388.7,y:199.7},0).wait(1).to({rotation:16.5,x:389.5,y:198.5},0).wait(1).to({rotation:13.4,x:390.3,y:197.1},0).wait(1).to({rotation:10.1,x:391.2,y:195.4},0).wait(1).to({rotation:6.6,x:392.2,y:193.4},0).wait(1).to({rotation:2.9,x:393.2,y:191},0).wait(1).to({rotation:-0.9,x:394.3,y:188.3},0).wait(1).to({rotation:-4.9,x:395.3,y:185.2,alpha:0.986},0).wait(1).to({rotation:-9,x:396.2,y:181.6,alpha:0.945},0).wait(1).to({rotation:-13.3,x:397.1,y:177.4,alpha:0.834},0).wait(1).to({rotation:-17.9,x:397.6,y:172.6,alpha:0},0).wait(1));

	// Layer 18
	this.instance_14 = new lib.Symbol11();
	this.instance_14.setTransform(278.1,254.4,0.298,0.298,0,0,0,59.6,40.8);
	this.instance_14.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(1).to({regX:60,regY:41,x:295.1,y:241.8},0).wait(1).to({x:309.7,y:230.5},0).wait(1).to({x:322.1,y:220.4},0).wait(1).to({x:332.7,y:211.5},0).wait(1).to({x:341.6,y:203.6},0).wait(1).to({x:348.9,y:196.6},0).wait(1).to({x:354.8,y:190.4},0).wait(1).to({x:359.2,y:184.8},0).wait(1).to({x:360.2,y:183.2},0).wait(1).to({x:360.7,y:182.4},0).wait(1).to({x:361,y:181.7},0).wait(1).to({x:361.3,y:181.1},0).wait(1).to({x:361.6,y:180.6},0).wait(1).to({x:361.8,y:180.3},0).wait(1).to({x:361.9,y:179.9},0).wait(1).to({x:362.1,y:179.7},0).wait(1).to({x:362.2,y:179.5},0).wait(1).to({x:362.3,y:179.3},0).wait(1).to({x:362.4,y:179.1},0).wait(1).to({x:362.5,y:178.9},0).wait(1).to({y:178.7},0).wait(1).to({x:362.6,y:178.6},0).wait(1).to({x:362.7,y:178.4},0).wait(1).to({x:362.8,y:178.2},0).wait(1).to({x:362.9,y:178.1},0).wait(1).to({x:363,y:177.9},0).wait(1).to({y:177.7},0).wait(1).to({x:363.2,y:177.5},0).wait(1).to({x:363.3,y:177.2},0).wait(1).to({x:363.4,y:176.9},0).wait(1).to({x:363.6,y:176.5},0).wait(1).to({x:363.8,y:176},0).wait(1).to({x:364.1,y:175.4},0).wait(1).to({x:364.4,y:174.7},0).wait(1).to({x:364.8,y:173.9,alpha:0.5},0).wait(1).to({x:365.3,y:172.8,alpha:1},0).wait(1).to({x:365.8,y:171.5},0).wait(1).to({x:366.4,y:170},0).wait(1).to({x:367,y:168.1},0).wait(1).to({x:367.8,y:166},0).wait(1).to({x:368.5,y:163.4,alpha:0.986},0).wait(1).to({x:369.3,y:160.4,alpha:0.945},0).wait(1).to({x:369.9,y:156.9,alpha:0.834},0).wait(1).to({x:370.1,y:152.8,alpha:0},0).wait(1));

	// usta 2 copy
	this.instance_15 = new lib.Symbol12();
	this.instance_15.setTransform(285.6,258.1,0.298,0.298,0,0,0,35.8,16.9);
	this.instance_15.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(1).to({regX:36,regY:17,x:302.6,y:245.4,alpha:0.448},0).wait(1).to({x:317.1,y:234.1,alpha:0.8},0).wait(1).to({x:329.6,y:224.1,alpha:0.936},0).wait(1).to({x:340.1,y:215.2,alpha:1},0).wait(1).to({x:349.1,y:207.2},0).wait(1).to({x:356.4,y:200.3},0).wait(1).to({x:362.3,y:194.1},0).wait(1).to({x:366.7,y:188.5},0).wait(1).to({x:367.7,y:186.8},0).wait(1).to({x:368.1,y:186},0).wait(1).to({x:368.5,y:185.3},0).wait(1).to({x:368.8,y:184.7},0).wait(1).to({x:369,y:184.3},0).wait(1).to({x:369.2,y:183.9},0).wait(1).to({x:369.4,y:183.6},0).wait(1).to({x:369.5,y:183.3},0).wait(1).to({x:369.6,y:183.1},0).wait(1).to({x:369.7,y:182.9},0).wait(1).to({x:369.8,y:182.7},0).wait(1).to({x:369.9,y:182.6},0).wait(1).to({x:370,y:182.4},0).wait(1).to({x:370.1,y:182.2},0).wait(1).to({y:182.1},0).wait(1).to({x:370.2,y:181.9},0).wait(1).to({x:370.3,y:181.7},0).wait(1).to({x:370.4,y:181.5},0).wait(1).to({x:370.5,y:181.3},0).wait(1).to({x:370.6,y:181.1},0).wait(1).to({x:370.7,y:180.9},0).wait(1).to({x:370.9,y:180.5},0).wait(1).to({x:371.1,y:180.2},0).wait(1).to({x:371.3,y:179.7},0).wait(1).to({x:371.5,y:179.1},0).wait(1).to({x:371.9,y:178.4},0).wait(1).to({x:372.3,y:177.5,alpha:0.5},0).wait(1).to({x:372.7,y:176.4,alpha:0},0).wait(1).to({x:373.2,y:175.2},0).wait(1).to({x:373.8,y:173.6},0).wait(1).to({x:374.5,y:171.8},0).wait(1).to({x:375.2,y:169.6},0).wait(1).to({x:376,y:167},0).wait(1).to({x:376.7,y:164},0).wait(1).to({x:377.4,y:160.5},0).wait(1).to({x:377.6,y:156.4},0).wait(1));

	// nos
	this.instance_16 = new lib.Symbol24();
	this.instance_16.setTransform(277.5,245,0.298,0.298,0,0,0,20.8,14);
	this.instance_16.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(1).to({regX:21,x:294.6,y:233.2,alpha:0.448},0).wait(1).to({x:309.2,y:222.7,alpha:0.8},0).wait(1).to({x:321.7,y:213.3,alpha:0.936},0).wait(1).to({x:332.3,y:204.8,alpha:1},0).wait(1).to({x:341.2,y:197.3},0).wait(1).to({x:348.5,y:190.6},0).wait(1).to({x:354.3,y:184.7},0).wait(1).to({x:358.6,y:179.2},0).wait(1).to({x:359.6,y:177.6},0).wait(1).to({x:360.1,y:176.7},0).wait(1).to({x:360.4,y:176},0).wait(1).to({x:360.7,y:175.5},0).wait(1).to({x:361,y:175},0).wait(1).to({x:361.2,y:174.6},0).wait(1).to({x:361.3,y:174.3},0).wait(1).to({x:361.5,y:174.1},0).wait(1).to({x:361.6,y:173.8},0).wait(1).to({x:361.7,y:173.6},0).wait(1).to({x:361.8,y:173.4},0).wait(1).to({y:173.3},0).wait(1).to({x:361.9,y:173.1},0).wait(1).to({x:362,y:172.9},0).wait(1).to({x:362.1,y:172.8},0).wait(1).to({x:362.2,y:172.6},0).wait(1).to({x:362.3,y:172.4},0).wait(1).to({y:172.2},0).wait(1).to({x:362.4,y:172},0).wait(1).to({x:362.5,y:171.8},0).wait(1).to({x:362.7,y:171.5},0).wait(1).to({x:362.8,y:171.2},0).wait(1).to({x:363,y:170.8},0).wait(1).to({x:363.2,y:170.4},0).wait(1).to({x:363.5,y:169.8},0).wait(1).to({x:363.8,y:169},0).wait(1).to({x:364.2,y:168.2},0).wait(1).to({x:364.6,y:167.1},0).wait(1).to({x:365.2,y:165.8},0).wait(1).to({x:365.8,y:164.2},0).wait(1).to({x:366.4,y:162.4},0).wait(1).to({x:367.2,y:160.2},0).wait(1).to({x:367.9,y:157.6,alpha:0.986},0).wait(1).to({x:368.7,y:154.6,alpha:0.945},0).wait(1).to({x:369.3,y:151.1,alpha:0.834},0).wait(1).to({x:369.5,y:147,alpha:0},0).wait(1));

	// Layer 11 copy 3
	this.instance_17 = new lib.Symbol27();
	this.instance_17.setTransform(283.6,246.8,0.298,0.298,-0.3,0,0,93,74);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(1).to({regX:93.5,regY:73.5,rotation:-0.4,x:300.6,y:234},0).wait(1).to({rotation:-0.7,x:315.2,y:222.6},0).wait(1).to({rotation:-1.1,x:327.7,y:212.6},0).wait(1).to({rotation:-1.4,x:338.3,y:203.7},0).wait(1).to({rotation:-1.8,x:347.1,y:195.8},0).wait(1).to({rotation:-2.3,x:354.4,y:188.7},0).wait(1).to({rotation:-3.3,x:360.3,y:182.6},0).wait(1).to({rotation:-5.9,x:364.8,y:177},0).wait(1).to({rotation:-8.9,x:365.7,y:175.3},0).wait(1).to({rotation:-9.9,x:366.2,y:174.5},0).wait(1).to({rotation:-10.3,x:366.5,y:173.9},0).wait(1).to({rotation:-10.5,x:366.9,y:173.2},0).wait(1).to({rotation:-10.6,x:367.1,y:172.8},0).wait(1).to({rotation:-10.7,x:367.3,y:172.4},0).wait(1).to({rotation:-10.8,x:367.4,y:172.1},0).wait(1).to({rotation:-10.9,x:367.6,y:171.8},0).wait(1).to({x:367.7,y:171.6},0).wait(1).to({rotation:-11,x:367.8,y:171.4},0).wait(1).to({x:367.9,y:171.2},0).wait(1).to({rotation:-11.1,y:171.1},0).wait(1).to({x:368,y:170.9},0).wait(1).to({rotation:-11.2,x:368.1,y:170.7},0).wait(1).to({x:368.2,y:170.5},0).wait(1).to({x:368.3,y:170.4},0).wait(1).to({x:368.4,y:170.2},0).wait(1).to({rotation:-11.3,y:170},0).wait(1).to({x:368.6,y:169.8},0).wait(1).to({x:368.7,y:169.6},0).wait(1).to({x:368.8,y:169.3},0).wait(1).to({x:368.9,y:169},0).wait(1).to({x:369.1,y:168.6},0).wait(1).to({rotation:-11.4,x:369.3,y:168.1},0).wait(1).to({x:369.6,y:167.6},0).wait(1).to({x:369.9,y:166.8},0).wait(1).to({x:370.3,y:166,alpha:1},0).wait(1).to({x:370.7,y:164.9},0).wait(1).to({x:371.3,y:163.6},0).wait(1).to({x:371.9,y:162.1},0).wait(1).to({x:372.5,y:160.3},0).wait(1).to({x:373.3,y:158.1},0).wait(1).to({x:374,y:155.5},0).wait(1).to({x:374.8,y:152.5},0).wait(1).to({x:375.4,y:149,alpha:0.871},0).wait(1).to({x:375.6,y:144.9,alpha:0},0).wait(1));

	// oko cele copy 3
	this.instance_18 = new lib.Symbol28();
	this.instance_18.setTransform(283.6,246.7,0.298,0.298,-0.3,0,0,93,86.5);
	this.instance_18.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(1).to({regX:93.5,regY:85.2,rotation:-0.4,x:300.7,y:233.6,alpha:0.448},0).wait(1).to({rotation:-0.7,x:315.3,y:222.2,alpha:0.8},0).wait(1).to({rotation:-1.1,x:327.7,y:212.2,alpha:0.936},0).wait(1).to({rotation:-1.4,x:338.2,y:203.3,alpha:1},0).wait(1).to({rotation:-1.8,x:347.2,y:195.4},0).wait(1).to({rotation:-2.3,x:354.5,y:188.4},0).wait(1).to({rotation:-3.3,x:360.3,y:182.2},0).wait(1).to({rotation:-5.9,x:364.7,y:176.6},0).wait(1).to({rotation:-8.9,x:365.7,y:175},0).wait(1).to({rotation:-9.9,x:366.2,y:174.1},0).wait(1).to({rotation:-10.3,x:366.5,y:173.5},0).wait(1).to({rotation:-10.5,x:366.8,y:172.9},0).wait(1).to({rotation:-10.6,x:367,y:172.4},0).wait(1).to({rotation:-10.7,x:367.2,y:172.1},0).wait(1).to({rotation:-10.8,x:367.4,y:171.7},0).wait(1).to({rotation:-10.9,x:367.6,y:171.5},0).wait(1).to({x:367.7,y:171.2},0).wait(1).to({rotation:-11,x:367.8,y:171},0).wait(1).to({x:367.9,y:170.8},0).wait(1).to({rotation:-11.1,y:170.7},0).wait(1).to({x:368,y:170.5},0).wait(1).to({rotation:-11.2,x:368.1,y:170.3},0).wait(1).to({y:170.2},0).wait(1).to({x:368.3,y:170},0).wait(1).to({y:169.9},0).wait(1).to({rotation:-11.3,x:368.4,y:169.7},0).wait(1).to({x:368.5,y:169.5},0).wait(1).to({x:368.6,y:169.3},0).wait(1).to({x:368.8,y:169},0).wait(1).to({x:368.9,y:168.7},0).wait(1).to({x:369.1,y:168.3},0).wait(1).to({rotation:-11.4,x:369.3,y:167.8},0).wait(1).to({x:369.6,y:167.2},0).wait(1).to({x:369.9,y:166.5},0).wait(1).to({x:370.3,y:165.6,alpha:0},0).wait(1).to({x:370.7,y:164.5},0).wait(1).to({x:371.2,y:163.3},0).wait(1).to({x:371.8,y:161.7},0).wait(1).to({x:372.5,y:159.9},0).wait(1).to({x:373.2,y:157.7},0).wait(1).to({x:374,y:155.1},0).wait(1).to({x:374.8,y:152.1},0).wait(1).to({x:375.4,y:148.6},0).wait(1).to({x:375.6,y:144.5},0).wait(1));

	// viecko
	this.instance_19 = new lib.Symbol64();
	this.instance_19.setTransform(278,240.5,0.261,0.256,-0.3,0,0,10.9,6.5);
	this.instance_19.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(1).to({regX:10.8,regY:6.2,rotation:-0.4,x:294.9,y:227.8},0).wait(1).to({rotation:-0.7,x:309.5,y:216.4},0).wait(1).to({rotation:-1.1,x:322,y:206.4},0).wait(1).to({rotation:-1.4,x:332.5,y:197.5},0).wait(1).to({rotation:-1.8,x:341.4,y:189.6},0).wait(1).to({rotation:-2.3,x:348.7,y:182.6},0).wait(1).to({rotation:-3.3,x:354.6,y:176.4},0).wait(1).to({rotation:-5.9,x:359,y:170.8},0).wait(1).to({rotation:-8.9,x:360.1,y:169.1},0).wait(1).to({rotation:-9.9,x:360.4,y:168.3},0).wait(1).to({rotation:-10.3,x:360.8,y:167.7},0).wait(1).to({rotation:-10.5,x:361.1,y:167.1},0).wait(1).to({rotation:-10.6,x:361.4,y:166.6},0).wait(1).to({rotation:-10.7,x:361.6,y:166.2},0).wait(1).to({rotation:-10.8,x:361.7,y:165.9},0).wait(1).to({rotation:-10.9,x:361.9,y:165.7},0).wait(1).to({x:362,y:165.4},0).wait(1).to({rotation:-11,x:362.1,y:165.2},0).wait(1).to({x:362.2,y:165},0).wait(1).to({rotation:-11.1,y:164.9},0).wait(1).to({x:362.3,y:164.7},0).wait(1).to({rotation:-11.2,x:362.4,y:164.5},0).wait(1).to({x:362.5,y:164.4},0).wait(1).to({x:362.6,y:164.2},0).wait(1).to({x:362.7,y:164},0).wait(1).to({rotation:-11.3,y:163.9},0).wait(1).to({x:362.8,y:163.7,alpha:1},0).wait(1).to({x:362.9,y:163.4,alpha:0},0).wait(1).to({x:363.1,y:163.2},0).wait(1).to({x:363.2,y:162.9},0).wait(1).to({x:363.4,y:162.5},0).wait(1).to({rotation:-11.4,x:363.6,y:162},0).wait(1).to({x:363.9,y:161.4},0).wait(1).to({x:364.2,y:160.7},0).wait(1).to({x:364.6,y:159.8},0).wait(1).to({x:365,y:158.8},0).wait(1).to({x:365.6,y:157.5},0).wait(1).to({x:366.2,y:155.9},0).wait(1).to({x:366.8,y:154.1},0).wait(1).to({x:367.6,y:151.9},0).wait(1).to({x:368.3,y:149.4},0).wait(1).to({x:369.1,y:146.4},0).wait(1).to({x:369.7,y:142.8},0).wait(1).to({x:369.9,y:138.8},0).wait(1));

	// oko vnutropoza b
	this.instance_20 = new lib.Symbol29();
	this.instance_20.setTransform(279,241,0.298,0.298,-0.3,0,0,52.2,26.6);
	this.instance_20.alpha = 0.02;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(1).to({regX:52.5,regY:26.5,rotation:-0.4,x:295.8,y:228.7,alpha:0.454},0).wait(1).to({rotation:-0.7,x:310.1,y:217.7,alpha:0.8},0).wait(1).to({rotation:-1.1,x:322.3,y:207.8,alpha:0.936},0).wait(1).to({rotation:-1.4,x:332.7,y:199.1,alpha:1},0).wait(1).to({rotation:-1.8,x:341.4,y:191.3},0).wait(1).to({rotation:-2.3,x:348.4,y:184.5},0).wait(1).to({rotation:-3.3,x:354.1,y:178.3},0).wait(1).to({rotation:-5.9,x:358.4,y:172.8},0).wait(1).to({rotation:-8.9,x:359.4,y:171},0).wait(1).to({rotation:-9.9,x:359.9,y:170},0).wait(1).to({rotation:-10.3,x:360.3,y:169.2},0).wait(1).to({rotation:-10.5,x:360.6,y:168.5},0).wait(1).to({rotation:-10.6,x:360.9,y:167.9},0).wait(1).to({rotation:-10.7,x:361.1,y:167.5},0).wait(1).to({rotation:-10.8,x:361.3,y:167.1},0).wait(1).to({rotation:-10.9,x:361.5,y:166.9},0).wait(1).to({x:361.6,y:166.6},0).wait(1).to({rotation:-11,x:361.7,y:166.4},0).wait(1).to({x:361.8,y:166.2},0).wait(1).to({rotation:-11.1,x:361.9,y:166},0).wait(1).to({x:362,y:165.8},0).wait(1).to({rotation:-11.2,x:362.1,y:165.6},0).wait(1).to({x:362.2,y:165.4},0).wait(1).to({x:362.3,y:165.2},0).wait(1).to({x:362.4,y:165},0).wait(1).to({rotation:-11.3,x:362.5,y:164.8},0).wait(1).to({x:362.6,y:164.6},0).wait(1).to({x:362.7,y:164.3},0).wait(1).to({x:362.9,y:164},0).wait(1).to({x:363,y:163.6},0).wait(1).to({x:363.2,y:163.2},0).wait(1).to({rotation:-11.4,x:363.5,y:162.6},0).wait(1).to({x:363.8,y:161.9},0).wait(1).to({x:364.1,y:161.1},0).wait(1).to({x:364.6,y:160.1,alpha:0},0).wait(1).to({x:365.1,y:158.9},0).wait(1).to({x:365.7,y:157.4},0).wait(1).to({x:366.4,y:155.6},0).wait(1).to({x:367.2,y:153.5},0).wait(1).to({x:368.1,y:151},0).wait(1).to({x:369.1,y:148},0).wait(1).to({x:370.1,y:144.6},0).wait(1).to({x:371.2,y:140.6},0).wait(1).to({x:372.1,y:136},0).wait(1));

	// oko vnutro poza a
	this.instance_21 = new lib.Symbol29();
	this.instance_21.setTransform(281,237,0.298,0.298,-0.3,0,0,52.2,27.4);
	this.instance_21.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(1).to({regX:52.5,regY:26.5,rotation:-0.4,x:299.4,y:224.6},0).wait(1).to({rotation:-0.7,x:315.1,y:213.6},0).wait(1).to({rotation:-1,x:328.5,y:203.6},0).wait(1).to({rotation:-1.3,x:339.6,y:194.6},0).wait(1).to({rotation:-1.6,x:348.8,y:186.3},0).wait(1).to({rotation:-2.1,x:356.1,y:178.7},0).wait(1).to({rotation:-3.1,x:361.1,y:171.4},0).wait(1).to({rotation:-5.7,x:362.1,y:168.8},0).wait(1).to({rotation:-8.8,x:362.4,y:167.6},0).wait(1).to({rotation:-9.8,x:362.7,y:166.6},0).wait(1).to({rotation:-10.1,x:363,y:165.8},0).wait(1).to({rotation:-10.3,x:363.2,y:165.2},0).wait(1).to({rotation:-10.4,x:363.4,y:164.7},0).wait(1).to({rotation:-10.5,x:363.5,y:164.2},0).wait(1).to({rotation:-10.6,x:363.6,y:163.9},0).wait(1).to({x:363.7,y:163.6},0).wait(1).to({rotation:-10.7,y:163.3},0).wait(1).to({x:363.8,y:163.1},0).wait(1).to({rotation:-10.8,x:363.9,y:162.9},0).wait(1).to({x:364,y:162.7},0).wait(1).to({rotation:-10.9,y:162.5},0).wait(1).to({x:364.1,y:162.3},0).wait(1).to({y:162.1},0).wait(1).to({x:364.2,y:161.9},0).wait(1).to({x:364.3,y:161.8},0).wait(1).to({rotation:-11,y:161.6},0).wait(1).to({x:364.4,y:161.3},0).wait(1).to({x:364.5,y:161},0).wait(1).to({x:364.6,y:160.7},0).wait(1).to({x:364.7,y:160.4},0).wait(1).to({x:364.8,y:160},0).wait(1).to({x:365,y:159.4},0).wait(1).to({x:365.2,y:158.8},0).wait(1).to({x:365.4,y:158},0).wait(1).to({x:365.7,y:157,alpha:1},0).wait(1).to({x:366.1,y:155.8},0).wait(1).to({x:366.5,y:154.4},0).wait(1).to({x:367,y:152.7},0).wait(1).to({x:367.6,y:150.8},0).wait(1).to({x:368.3,y:148.4},0).wait(1).to({x:369.1,y:145.7,alpha:0.986},0).wait(1).to({x:370.1,y:142.5,alpha:0.945},0).wait(1).to({x:371.2,y:138.9,alpha:0.834},0).wait(1).to({x:372.4,y:134.7,alpha:0},0).wait(1));

	// oko vonk prave
	this.instance_22 = new lib.Symbol30();
	this.instance_22.setTransform(280.3,237.9,0.298,0.298,-0.3,0,0,68.7,38.5);
	this.instance_22.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(1).to({regX:69,rotation:-0.4,x:297.3,y:225.2,alpha:0.448},0).wait(1).to({rotation:-0.7,x:311.9,y:213.9,alpha:0.8},0).wait(1).to({rotation:-1.1,x:324.3,y:203.8,alpha:0.905},0).wait(1).to({rotation:-1.4,x:334.9,y:195,alpha:0.955},0).wait(1).to({rotation:-1.8,x:343.8,y:187,alpha:0.984},0).wait(1).to({rotation:-2.3,x:351.2,y:180.1,alpha:1},0).wait(1).to({rotation:-3.3,x:357,y:173.9},0).wait(1).to({rotation:-5.9,x:361.5,y:168.3},0).wait(1).to({rotation:-8.9,x:362.4,y:166.7},0).wait(1).to({rotation:-9.9,x:362.9,y:165.8},0).wait(1).to({rotation:-10.3,x:363.2,y:165.2},0).wait(1).to({rotation:-10.5,x:363.5,y:164.5},0).wait(1).to({rotation:-10.6,x:363.8,y:164},0).wait(1).to({rotation:-10.7,x:364,y:163.7},0).wait(1).to({rotation:-10.8,x:364.1,y:163.4},0).wait(1).to({rotation:-10.9,x:364.3,y:163.2},0).wait(1).to({y:162.9},0).wait(1).to({rotation:-11,x:364.5,y:162.7},0).wait(1).to({x:364.6,y:162.5},0).wait(1).to({rotation:-11.1,y:162.4},0).wait(1).to({x:364.7,y:162.2},0).wait(1).to({rotation:-11.2,x:364.8,y:162.1},0).wait(1).to({x:364.9,y:161.8},0).wait(1).to({x:365,y:161.7},0).wait(1).to({x:365.1,y:161.5},0).wait(1).to({rotation:-11.3,x:365.2,y:161.4},0).wait(1).to({x:365.3,y:161.2},0).wait(1).to({x:365.4,y:160.9},0).wait(1).to({x:365.5,y:160.6},0).wait(1).to({x:365.6,y:160.3},0).wait(1).to({x:365.8,y:160},0).wait(1).to({rotation:-11.4,x:366,y:159.5},0).wait(1).to({x:366.3,y:158.9},0).wait(1).to({x:366.6,y:158.2},0).wait(1).to({x:367,y:157.3},0).wait(1).to({x:367.4,y:156.3},0).wait(1).to({x:368,y:155},0).wait(1).to({x:368.6,y:153.4},0).wait(1).to({x:369.2,y:151.6},0).wait(1).to({x:370,y:149.4},0).wait(1).to({x:370.7,y:146.9,alpha:0.986},0).wait(1).to({x:371.5,y:143.8,alpha:0.945},0).wait(1).to({x:372.1,y:140.3,alpha:0.834},0).wait(1).to({x:372.3,y:136.2,alpha:0},0).wait(1));

	// bielko prave
	this.instance_23 = new lib.Symbol31();
	this.instance_23.setTransform(280.3,242.1,0.298,0.298,0,0,0,64.7,40.8);
	this.instance_23.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(1).to({regX:65,regY:41,x:297.3,y:229.4,alpha:0.448},0).wait(1).to({x:311.9,y:218.1,alpha:0.8},0).wait(1).to({x:324.3,y:208.1,alpha:1},0).wait(1).to({x:334.9,y:199.2},0).wait(1).to({x:343.8,y:191.2},0).wait(1).to({x:351.1,y:184.3},0).wait(1).to({x:357,y:178.1},0).wait(1).to({x:361.4,y:172.5},0).wait(1).to({x:362.4,y:170.8},0).wait(1).to({x:362.9,y:170},0).wait(1).to({x:363.2,y:169.3},0).wait(1).to({x:363.5,y:168.7},0).wait(1).to({x:363.8,y:168.3},0).wait(1).to({x:364,y:167.9},0).wait(1).to({x:364.1,y:167.6},0).wait(1).to({x:364.3,y:167.3},0).wait(1).to({x:364.4,y:167.1},0).wait(1).to({x:364.5,y:166.9},0).wait(1).to({x:364.6,y:166.7},0).wait(1).to({x:364.7,y:166.6},0).wait(1).to({y:166.4},0).wait(1).to({x:364.8,y:166.2},0).wait(1).to({x:364.9,y:166.1},0).wait(1).to({x:365,y:165.9},0).wait(1).to({x:365.1,y:165.7},0).wait(1).to({x:365.2,y:165.5},0).wait(1).to({y:165.3},0).wait(1).to({x:365.4,y:165.1},0).wait(1).to({x:365.5,y:164.9},0).wait(1).to({x:365.6,y:164.5},0).wait(1).to({x:365.8,y:164.2},0).wait(1).to({x:366,y:163.7},0).wait(1).to({x:366.3,y:163.1},0).wait(1).to({x:366.6,y:162.4},0).wait(1).to({x:367,y:161.5},0).wait(1).to({x:367.5,y:160.4},0).wait(1).to({x:368,y:159.2},0).wait(1).to({x:368.6,y:157.6},0).wait(1).to({x:369.2,y:155.8},0).wait(1).to({x:370,y:153.6},0).wait(1).to({x:370.7,y:151,alpha:0.986},0).wait(1).to({x:371.5,y:148,alpha:0.945},0).wait(1).to({x:372.1,y:144.5,alpha:0.834},0).wait(1).to({x:372.3,y:140.4,alpha:0},0).wait(1));

	// COP
	this.instance_24 = new lib.Symbol32();
	this.instance_24.setTransform(307.4,220.8,0.298,0.298,0,0,0,138.2,49.9);
	this.instance_24.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(1).to({regX:138.5,regY:50,x:324.5,y:208.1,alpha:0.448},0).wait(1).to({x:339,y:196.8,alpha:0.8},0).wait(1).to({x:351.5,y:186.8,alpha:1},0).wait(1).to({x:362,y:177.9},0).wait(1).to({x:371,y:169.9},0).wait(1).to({x:378.3,y:163},0).wait(1).to({x:384.2,y:156.8},0).wait(1).to({x:388.6,y:151.2},0).wait(1).to({x:389.6,y:149.5},0).wait(1).to({x:390,y:148.7},0).wait(1).to({x:390.4,y:148},0).wait(1).to({x:390.7,y:147.4},0).wait(1).to({x:390.9,y:147},0).wait(1).to({x:391.1,y:146.6},0).wait(1).to({x:391.3,y:146.3},0).wait(1).to({x:391.4,y:146},0).wait(1).to({x:391.5,y:145.8},0).wait(1).to({x:391.6,y:145.6},0).wait(1).to({x:391.7,y:145.4},0).wait(1).to({x:391.8,y:145.3},0).wait(1).to({x:391.9,y:145.1},0).wait(1).to({x:392,y:144.9},0).wait(1).to({y:144.8},0).wait(1).to({x:392.1,y:144.6},0).wait(1).to({x:392.2,y:144.4},0).wait(1).to({x:392.3,y:144.2},0).wait(1).to({x:392.4,y:144},0).wait(1).to({x:392.5,y:143.8},0).wait(1).to({x:392.6,y:143.6},0).wait(1).to({x:392.8,y:143.2},0).wait(1).to({x:393,y:142.9},0).wait(1).to({x:393.2,y:142.4},0).wait(1).to({x:393.4,y:141.8},0).wait(1).to({x:393.8,y:141.1},0).wait(1).to({x:394.2,y:140.2},0).wait(1).to({x:394.6,y:139.1},0).wait(1).to({x:395.1,y:137.9},0).wait(1).to({x:395.7,y:136.3},0).wait(1).to({x:396.4,y:134.5},0).wait(1).to({x:397.1,y:132.3},0).wait(1).to({x:397.9,y:129.7,alpha:0.986},0).wait(1).to({x:398.6,y:126.7,alpha:0.945},0).wait(1).to({x:399.3,y:123.2,alpha:0.834},0).wait(1).to({x:399.5,y:119.1,alpha:0},0).wait(1));
	...
	// vlasky
	this.instance_25 = new lib.Symbol62copy();
	this.instance_25.setTransform(344.7,186.5,1,1,0,0,0,88.9,59.1);
	this.instance_25.alpha = 0;

	this.instance_25.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(1).to({regY:62.1,x:343.3,y:189.9},0).wait(1).to({x:342,y:190.4,alpha:0.5},0).wait(1).to({x:340.7,y:190.8,alpha:1},0).wait(1).to({x:339.4,y:191.3},0).wait(1).to({x:338.1,y:191.7},0).wait(1).to({x:336.8,y:192.1},0).wait(1).to({x:335.5,y:192.6},0).wait(1).to({x:334.1,y:193},0).wait(1).to({x:332.8,y:193.4},0).wait(1).to({x:331.5,y:193.9},0).wait(1).to({x:330.2,y:194.3},0).wait(1).to({x:328.9,y:194.8},0).wait(1).to({x:327.6,y:195.2},0).wait(1).to({x:326.3,y:195.6},0).wait(1).to({x:324.9,y:196.1},0).wait(1).to({x:323.6,y:196.5},0).wait(1).to({x:322.3,y:197},0).wait(1).to({x:321,y:197.4},0).wait(1).to({x:319.7,y:197.8},0).wait(1).to({x:318.4,y:198.3},0).wait(1).to({x:317.1,y:198.7},0).wait(1).to({x:315.8,y:199.2},0).wait(1).to({x:314.4,y:199.6},0).wait(1).to({x:313.1,y:200},0).wait(1).to({x:311.8,y:200.5},0).wait(1).to({x:310.5,y:200.9},0).wait(1).to({x:309.2,y:201.3},0).wait(1).to({x:307.9,y:201.8},0).wait(1).to({x:306.6,y:202.2},0).wait(1).to({x:305.2,y:202.7},0).wait(1).to({x:303.9,y:203.1},0).wait(1).to({x:302.6,y:203.5},0).wait(1).to({x:301.3,y:204},0).wait(1).to({x:300,y:204.4},0).wait(1).to({x:298.7,y:204.9},0).wait(1).to({x:297.4,y:205.3},0).wait(1).to({x:296,y:205.7},0).wait(1).to({x:294.7,y:206.2},0).wait(1).to({x:293.4,y:206.6},0).wait(1).to({x:292.1,y:207},0).wait(1).to({x:290.8,y:207.5,alpha:0.75},0).wait(1).to({x:289.5,y:207.9,alpha:0.5},0).wait(1).to({x:288.2,y:208.4,alpha:0.25},0).wait(1).to({x:286.9,y:208.8,alpha:0},0).wait(1));

	// modry efekt
	this.instance_26 = new lib.Symbol65();
	this.instance_26.setTransform(323.8,259.8,1,1,0,0,0,97.2,80.4);
	this.instance_26.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(1).to({regX:93.7,regY:77.8,x:320.3,y:257.2},0).wait(4).to({alpha:0.032},0).wait(1).to({alpha:0.119},0).wait(1).to({alpha:1},0).wait(1).to({x:321,y:255.9,alpha:0.939},0).wait(1).to({x:321.8,y:254.7,alpha:0.88},0).wait(1).to({x:322.5,y:253.4,alpha:0.822},0).wait(1).to({x:323.3,y:252.2,alpha:0.765},0).wait(1).to({x:324,y:251,alpha:0.709},0).wait(1).to({x:324.8,y:249.7,alpha:0.654},0).wait(1).to({x:325.5,y:248.5,alpha:0.601},0).wait(1).to({x:326.3,y:247.3,alpha:0.548},0).wait(1).to({x:327,y:246,alpha:0.496},0).wait(1).to({x:327.8,y:244.8,alpha:0.446},0).wait(1).to({x:328.6,y:243.5,alpha:0.398},0).wait(1).to({x:329.3,y:242.3,alpha:0.35},0).wait(1).to({x:330.1,y:241.1,alpha:0.305},0).wait(1).to({x:330.8,y:239.8,alpha:0.261},0).wait(1).to({x:331.6,y:238.6,alpha:0.22},0).wait(1).to({x:332.3,y:237.4,alpha:0.183},0).wait(1).to({x:333.1,y:236.1,alpha:0.151},0).wait(1).to({x:333.8,y:234.9,alpha:0.124},0).wait(1).to({x:334.6,y:233.6,alpha:0.1},0).wait(1).to({x:335.4,y:232.4,alpha:0.079},0).wait(1).to({x:336.1,y:231.2,alpha:0.061},0).wait(1).to({x:336.9,y:229.9,alpha:0.046},0).wait(1).to({x:337.6,y:228.7,alpha:0.033},0).wait(1).to({x:338.4,y:227.5,alpha:0.022},0).wait(1).to({x:339.1,y:226.2,alpha:0.013},0).wait(1).to({x:339.9,y:225,alpha:0.007},0).wait(1).to({x:340.6,y:223.7,alpha:0.002},0).wait(1).to({x:341.4,y:222.5,alpha:0},0).wait(10));

	// bota 1
	this.instance_27 = new lib.Symbol35();
	this.instance_27.setTransform(222.8,296.3,0.313,0.313,0,0,0,14.4,15.1);
	this.instance_27.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(1).to({regX:14.5,regY:15,x:203.5,y:291.4,alpha:0.876},0).wait(1).to({x:186.8,y:287.2,alpha:0.965},0).wait(1).to({x:172.2,y:283.4,alpha:0.991},0).wait(1).to({x:159.7,y:280.1,alpha:1},0).wait(1).to({x:148.9,y:277.2},0).wait(1).to({x:139.8,y:274.7},0).wait(1).to({x:132,y:272.6},0).wait(1).to({x:125.6,y:270.7},0).wait(1).to({x:120.2,y:269.2},0).wait(1).to({x:115.7,y:267.8},0).wait(1).to({x:112.1,y:266.7},0).wait(1).to({x:109.1,y:265.7},0).wait(1).to({x:106.7,y:264.8},0).wait(1).to({x:104.5,y:264},0).wait(1).to({x:103.1,y:263.5},0).wait(1).to({x:102.1,y:263},0).wait(1).to({x:101.8,y:262.9},0).wait(1).to({x:101.5,y:262.7},0).wait(1).to({x:101.3,y:262.6},0).wait(1).to({x:101,y:262.5},0).wait(1).to({x:100.8,y:262.4},0).wait(1).to({x:100.6,y:262.2},0).wait(1).to({x:100.4,y:262.1},0).wait(1).to({x:100.2,y:262},0).wait(1).to({x:100,y:261.8},0).wait(1).to({x:99.8,y:261.7},0).wait(1).to({x:99.6,y:261.5},0).wait(1).to({x:99.3,y:261.3},0).wait(1).to({x:99,y:261.1},0).wait(1).to({x:98.7,y:260.7},0).wait(1).to({x:98.3,y:260.4},0).wait(1).to({x:97.8,y:259.8},0).wait(1).to({x:97.3,y:259.2},0).wait(1).to({x:96.8,y:258.3},0).wait(1).to({x:96.3,y:257.1},0).wait(1).to({x:96,y:255.7},0).wait(1).to({x:95.9,y:253.9},0).wait(1).to({x:96.2,y:251.7},0).wait(1).to({x:96.9,y:249.3},0).wait(1).to({x:98.2,y:246.6},0).wait(1).to({x:100,y:243.5},0).wait(1).to({x:102.3,y:240.3,alpha:0.93},0).wait(1).to({x:105.3,y:236.7,alpha:0.765},0).wait(1).to({x:109.1,y:232.8,alpha:0},0).wait(1));

	// bota 0
	this.instance_28 = new lib.Symbol36();
	this.instance_28.setTransform(272.5,306.6,0.313,0.313,0,0,0,18.9,20.4);
	this.instance_28.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(1).to({regX:19,regY:20.5,x:257.1,y:306,alpha:0.876},0).wait(1).to({x:243.7,y:305.2,alpha:0.965},0).wait(1).to({x:232.1,y:304.1,alpha:0.991},0).wait(1).to({x:222,y:302.8,alpha:1},0).wait(1).to({x:213.5,y:301.4},0).wait(1).to({x:206.3,y:299.9},0).wait(1).to({x:200.2,y:298.4},0).wait(1).to({x:195.3,y:296.7},0).wait(1).to({x:191.3,y:295},0).wait(1).to({x:188.1,y:293.2},0).wait(1).to({x:185.8,y:291.4},0).wait(1).to({x:184.2,y:289.6},0).wait(1).to({x:183.3,y:288},0).wait(1).to({x:182.9,y:286.5},0).wait(1).to({y:285.2},0).wait(1).to({x:183,y:284},0).wait(1).to({x:183.1,y:283.7},0).wait(1).to({x:183.2,y:283.4},0).wait(1).to({y:283.2},0).wait(1).to({x:183.3,y:282.9},0).wait(1).to({y:282.7},0).wait(1).to({x:183.4,y:282.4},0).wait(1).to({y:282.2},0).wait(1).to({x:183.5,y:282},0).wait(1).to({y:281.7},0).wait(1).to({x:183.6,y:281.5},0).wait(1).to({y:281.2},0).wait(1).to({x:183.7,y:280.9},0).wait(1).to({y:280.5},0).wait(1).to({x:183.8,y:280},0).wait(1).to({y:279.5},0).wait(1).to({x:183.9,y:278.8},0).wait(1).to({x:184,y:278},0).wait(1).to({x:184.1,y:277},0).wait(1).to({y:275.8},0).wait(1).to({y:274.3},0).wait(1).to({x:183.9,y:272.5},0).wait(1).to({x:183.7,y:270.4},0).wait(1).to({x:183.1,y:267.9},0).wait(1).to({x:182.2,y:265.1},0).wait(1).to({x:180.7,y:262},0).wait(1).to({x:178.5,y:258.7,alpha:0.93},0).wait(1).to({x:175.4,y:255.3,alpha:0.765},0).wait(1).to({x:171.1,y:252.1,alpha:0},0).wait(1));

	// Layer 8
	this.instance_29 = new lib.Symbol37();
	this.instance_29.setTransform(241,291.1,0.313,0.313,43,0,0,187.8,120.8);
	this.instance_29.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(1).to({regX:182,regY:142,rotation:37.9,x:220,y:290.6,alpha:0.876},0).wait(1).to({rotation:32.5,x:207,y:287.1,alpha:0.965},0).wait(1).to({rotation:26.8,x:195.8,y:283.9,alpha:0.991},0).wait(1).to({rotation:20.7,x:186.4,y:281.2,alpha:1},0).wait(1).to({rotation:13.9,x:178.5,y:278.7},0).wait(1).to({rotation:6.2,x:172.1,y:276.6},0).wait(1).to({rotation:-4.5,x:167.3,y:274.7},0).wait(1).to({rotation:-9.5,x:162.7,y:272.8},0).wait(1).to({rotation:-10.4,x:158.6,y:271.1},0).wait(1).to({rotation:-10,x:155.1,y:269.6},0).wait(1).to({rotation:-8.1,x:152.1,y:268.3},0).wait(1).to({rotation:-6.4,x:149.6,y:267.1},0).wait(1).to({rotation:-4.9,x:147.6,y:266.1},0).wait(1).to({rotation:-3.7,x:145.9,y:265.1},0).wait(1).to({rotation:-2.7,x:144.8,y:264.3},0).wait(1).to({rotation:-2,x:143.9,y:263.7},0).wait(1).to({rotation:-1.7,x:143.7,y:263.5},0).wait(1).to({rotation:-1.5,x:143.6,y:263.4},0).wait(1).to({x:143.4,y:263.2},0).wait(1).to({x:143.3,y:263.1},0).wait(1).to({rotation:-1.6,x:143.1,y:263},0).wait(1).to({rotation:-1.8,y:262.9},0).wait(1).to({rotation:-2,x:142.9,y:262.8},0).wait(1).to({rotation:-2.3,x:142.8,y:262.7},0).wait(1).to({rotation:-2.6,x:142.7,y:262.6},0).wait(1).to({rotation:-2.9,y:262.5},0).wait(1).to({rotation:-3.3,x:142.5,y:262.3},0).wait(1).to({rotation:-3.8,x:142.4,y:262.1},0).wait(1).to({x:142.2,y:261.9},0).wait(1).to({x:142,y:261.7},0).wait(1).to({x:141.7,y:261.4},0).wait(1).to({x:141.4,y:261},0).wait(1).to({x:141,y:260.6},0).wait(1).to({x:140.5,y:260},0).wait(1).to({x:139.9,y:259.3},0).wait(1).to({x:139.2,y:258.4},0).wait(1).to({x:138.5,y:257.3},0).wait(1).to({x:137.7,y:256},0).wait(1).to({x:136.9,y:254.3},0).wait(1).to({x:136.1,y:252.2},0).wait(1).to({x:135.6,y:249.7},0).wait(1).to({x:135.4,y:246.8,alpha:0.93},0).wait(1).to({x:136,y:243.4,alpha:0.765},0).wait(1).to({x:137.5,y:239.8,alpha:0},0).wait(1));

	// Layer 9
	this.instance_30 = new lib.Symbol38();
	this.instance_30.setTransform(243.8,296.4,0.313,0.313,0,0,0,120.8,90);
	...
	// vlasky copy
	this.instance_45 = new lib.Symbol62();
	this.instance_45.setTransform(138.4,215.7,1,1,0,0,180,88.9,59.1);
	this.instance_45.alpha = 0;

	this.instance_45.mask = mask_1;

	this.timeline.addTween(cjs.Tween.get(this.instance_45).wait(1).to({regY:62.1,x:139.5,y:219.3},0).wait(1).to({x:140.6,y:220,alpha:0.5},0).wait(1).to({x:141.7,y:220.7,alpha:1},0).wait(1).to({x:142.8,y:221.4},0).wait(1).to({x:143.9,y:222},0).wait(1).to({x:145,y:222.7},0).wait(1).to({x:146.1,y:223.4},0).wait(1).to({x:147.2,y:224.1},0).wait(1).to({x:148.3,y:224.8},0).wait(1).to({x:149.4,y:225.4},0).wait(1).to({x:150.5,y:226.1},0).wait(1).to({x:151.6,y:226.8},0).wait(1).to({x:152.7,y:227.5},0).wait(1).to({x:153.8,y:228.2},0).wait(1).to({x:154.9,y:228.8},0).wait(1).to({x:156,y:229.5},0).wait(1).to({x:157.1,y:230.2},0).wait(1).to({x:158.2,y:230.9},0).wait(1).to({x:159.3,y:231.6},0).wait(1).to({x:160.4,y:232.2},0).wait(1).to({x:161.5,y:232.9},0).wait(1).to({x:162.6,y:233.6},0).wait(1).to({x:163.6,y:234.3},0).wait(1).to({x:164.7,y:235},0).wait(1).to({x:165.8,y:235.6},0).wait(1).to({x:166.9,y:236.3},0).wait(1).to({x:168,y:237},0).wait(1).to({x:169.1,y:237.7},0).wait(1).to({x:170.2,y:238.4},0).wait(1).to({x:171.3,y:239},0).wait(1).to({x:172.4,y:239.7},0).wait(1).to({x:173.5,y:240.4},0).wait(1).to({x:174.6,y:241.1},0).wait(1).to({x:175.7,y:241.8},0).wait(1).to({x:176.8,y:242.4},0).wait(1).to({x:177.9,y:243.1},0).wait(1).to({x:179,y:243.8},0).wait(1).to({x:180.1,y:244.5},0).wait(1).to({x:181.2,y:245.2},0).wait(1).to({x:182.3,y:245.8},0).wait(1).to({x:183.4,y:246.5,alpha:0.75},0).wait(1).to({x:184.5,y:247.2,alpha:0.5},0).wait(1).to({x:185.6,y:247.9,alpha:0.25},0).wait(1).to({x:186.7,y:248.6,alpha:0},0).wait(1));

	// efekt red
	this.instance_46 = new lib.Symbol66();
	this.instance_46.setTransform(161.9,278.6,1,1,0,0,0,89,70);
	this.instance_46.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_46).wait(1).to({regX:81.6,regY:63.7,x:154.5,y:272.3},0).wait(7).to({x:154.1,y:272,alpha:0.068},0).wait(1).to({x:153.7,y:271.8,alpha:0.294},0).wait(1).to({x:153.3,y:271.5,alpha:1},0).wait(1).to({x:152.9,y:271.3,alpha:0.927},0).wait(1).to({x:152.5,y:271,alpha:0.856},0).wait(1).to({x:152.1,y:270.8,alpha:0.786},0).wait(1).to({x:151.8,y:270.5,alpha:0.718},0).wait(1).to({x:151.4,y:270.3,alpha:0.651},0).wait(1).to({x:151,y:270,alpha:0.586},0).wait(1).to({x:150.6,y:269.8,alpha:0.523},0).wait(1).to({x:150.2,y:269.5,alpha:0.462},0).wait(1).to({x:149.8,y:269.3,alpha:0.403},0).wait(1).to({x:149.5,y:269,alpha:0.346},0).wait(1).to({x:149.1,y:268.8,alpha:0.293},0).wait(1).to({x:148.7,y:268.5,alpha:0.243},0).wait(1).to({x:148.3,y:268.2,alpha:0.198},0).wait(1).to({x:147.9,y:268,alpha:0.159},0).wait(1).to({x:147.5,y:267.7,alpha:0.127},0).wait(1).to({x:147.2,y:267.5,alpha:0.101},0).wait(1).to({x:146.8,y:267.2,alpha:0.078},0).wait(1).to({x:146.4,y:267,alpha:0.06},0).wait(1).to({x:146,y:266.7,alpha:0.044},0).wait(1).to({x:145.6,y:266.5,alpha:0.032},0).wait(1).to({x:145.2,y:266.2,alpha:0.021},0).wait(1).to({x:144.9,y:266,alpha:0.013},0).wait(1).to({x:144.5,y:265.7,alpha:0.006},0).wait(1).to({x:144.1,y:265.5,alpha:0.002},0).wait(1).to({x:143.7,y:265.2,alpha:0},0).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(294,230,605.7,352.8);
